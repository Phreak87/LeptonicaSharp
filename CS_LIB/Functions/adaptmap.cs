...
if (pixs == null) {throw new ArgumentNullException  ("pixs cannot be Nothing");}
if (reduction < 2 || reduction > 16){   throw new ArgumentException ("at which morph closings are done between 2 and 16");}
	IntPtr piximPtr = IntPtr.Zero; 	if (pixim != null) {piximPtr = pixim.Pointer;}
...
if (pixs == null) {throw new ArgumentNullException  ("pixs cannot be Nothing");}
if (reduction < 2 || reduction > 16){   throw new ArgumentException ("factor at which closing is performed");}
	IntPtr piximPtr = IntPtr.Zero; 	if (pixim != null) {piximPtr = pixim.Pointer;}
