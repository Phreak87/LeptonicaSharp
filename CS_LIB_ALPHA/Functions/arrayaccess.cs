...
public static int l_getDataBit(
	...
	int _Result = Natives.l_getDataBit(
  linePtr,   n);
...
public static int l_getDataDibit(
	...
	int _Result = Natives.l_getDataDibit(
  linePtr,   n);
...
public static int l_getDataQbit(
	...
	int _Result = Natives.l_getDataQbit(
  linePtr,   n);
...
public static int l_getDataByte(
	...
	int _Result = Natives.l_getDataByte(
  linePtr,   n);
...
public static int l_getDataTwoBytes(
	...
	int _Result = Natives.l_getDataTwoBytes(
  linePtr,   n);
...
public static int l_getDataFourBytes(
	...
	int _Result = Natives.l_getDataFourBytes(
  linePtr,   n);
