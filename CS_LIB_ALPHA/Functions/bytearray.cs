...
public static L_Bytea l_byteaCreate(
	...
	IntPtr _Result = Natives.l_byteaCreate(
  nbytes);
...
public static L_Bytea l_byteaInitFromMem(
	...
	IntPtr _Result = Natives.l_byteaInitFromMem(
  data,   size);
...
public static L_Bytea l_byteaInitFromFile(
	...
	IntPtr _Result = Natives.l_byteaInitFromFile(
  fname);
...
public static L_Bytea l_byteaInitFromStream(
	...
	IntPtr _Result = Natives.l_byteaInitFromStream(
fp.Pointer);
...
public static L_Bytea l_byteaCopy(
	...
	IntPtr _Result = Natives.l_byteaCopy(
bas.Pointer,   copyflag);
...
public static uint l_byteaGetSize(
	...
	uint _Result = Natives.l_byteaGetSize(
ba.Pointer);
...
public static Byte[] l_byteaGetData(
	...
	Byte[] _Result = Natives.l_byteaGetData(
ba.Pointer, out  psize);
...
public static Byte[] l_byteaCopyData(
	...
	Byte[] _Result = Natives.l_byteaCopyData(
ba.Pointer, out  psize);
...
public static int l_byteaAppendData(
	...
	int _Result = Natives.l_byteaAppendData(
ba.Pointer,   newdata,   newbytes);
...
public static int l_byteaAppendString(
	...
	int _Result = Natives.l_byteaAppendString(
ba.Pointer,   str);
...
public static int l_byteaJoin(
	...
	int _Result = Natives.l_byteaJoin(
ba1.Pointer, ref pba2Ptr);
...
public static int l_byteaSplit(
	...
	int _Result = Natives.l_byteaSplit(
ba1.Pointer,   splitloc, out pba2Ptr);
...
public static int l_byteaFindEachSequence(
	...
	int _Result = Natives.l_byteaFindEachSequence(
ba.Pointer,   sequence,   seqlen, out pdaPtr);
...
public static int l_byteaWrite(
	...
	int _Result = Natives.l_byteaWrite(
  fname, ba.Pointer,   startloc,   endloc);
...
public static int l_byteaWriteStream(
	...
	int _Result = Natives.l_byteaWriteStream(
fp.Pointer, ba.Pointer,   startloc,   endloc);
