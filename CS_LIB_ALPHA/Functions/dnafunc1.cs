...
public static int l_dnaJoin(
	...
	int _Result = Natives.l_dnaJoin(
dad.Pointer, dasPtr,   istart,   iend);
...
public static L_Dna l_dnaaFlattenToDna(
	...
	IntPtr _Result = Natives.l_dnaaFlattenToDna(
daa.Pointer);
...
public static Numa l_dnaConvertToNuma(
	...
	IntPtr _Result = Natives.l_dnaConvertToNuma(
da.Pointer);
...
public static L_Dna numaConvertToDna(
	...
	IntPtr _Result = Natives.numaConvertToDna(
na.Pointer);
...
public static L_Dna l_dnaUnionByAset(
	...
	IntPtr _Result = Natives.l_dnaUnionByAset(
...
public static L_Dna l_dnaRemoveDupsByAset(
	...
	IntPtr _Result = Natives.l_dnaRemoveDupsByAset(
das.Pointer);
...
public static L_Dna l_dnaIntersectionByAset(
	...
	IntPtr _Result = Natives.l_dnaIntersectionByAset(
da1.Pointer, da2.Pointer);
...
public static L_Rbtree l_asetCreateFromDna(
	...
	IntPtr _Result = Natives.l_asetCreateFromDna(
da.Pointer);
...
public static L_Dna l_dnaDiffAdjValues(
	...
	IntPtr _Result = Natives.l_dnaDiffAdjValues(
das.Pointer);
