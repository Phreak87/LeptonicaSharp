...
public static FPix fpixCreate(
	...
	IntPtr _Result = Natives.fpixCreate(
  width,   height);
...
public static FPix fpixCreateTemplate(
	...
	IntPtr _Result = Natives.fpixCreateTemplate(
fpixs.Pointer);
...
public static FPix fpixClone(
	...
	IntPtr _Result = Natives.fpixClone(
fpix.Pointer);
...
public static FPix fpixCopy(
	...
	IntPtr _Result = Natives.fpixCopy(
...
public static int fpixResizeImageData(
	...
	int _Result = Natives.fpixResizeImageData(
fpixd.Pointer, fpixs.Pointer);
...
public static int fpixGetDimensions(
	...
	int _Result = Natives.fpixGetDimensions(
fpix.Pointer, out  pw, out  ph);
...
public static int fpixSetDimensions(
	...
	int _Result = Natives.fpixSetDimensions(
fpix.Pointer,   w,   h);
...
public static int fpixGetWpl(
	...
	int _Result = Natives.fpixGetWpl(
fpix.Pointer);
...
public static int fpixSetWpl(
	...
	int _Result = Natives.fpixSetWpl(
fpix.Pointer,   wpl);
...
public static int fpixGetRefcount(
	...
	int _Result = Natives.fpixGetRefcount(
fpix.Pointer);
...
public static int fpixChangeRefcount(
	...
	int _Result = Natives.fpixChangeRefcount(
fpix.Pointer,   delta);
...
public static int fpixGetResolution(
	...
	int _Result = Natives.fpixGetResolution(
fpix.Pointer, out  pxres, out  pyres);
...
public static int fpixSetResolution(
	...
	int _Result = Natives.fpixSetResolution(
fpix.Pointer,   xres,   yres);
...
public static int fpixCopyResolution(
	...
	int _Result = Natives.fpixCopyResolution(
fpixd.Pointer, fpixs.Pointer);
...
public static Single[] fpixGetData(
	...
	Single[] _Result = Natives.fpixGetData(
fpix.Pointer);
...
public static int fpixSetData(
	...
	int _Result = Natives.fpixSetData(
fpix.Pointer,   data);
...
public static int fpixGetPixel(
	...
	int _Result = Natives.fpixGetPixel(
fpix.Pointer,   x,   y, out  pval);
...
public static int fpixSetPixel(
	...
	int _Result = Natives.fpixSetPixel(
fpix.Pointer,   x,   y,   val);
...
public static FPixa fpixaCreate(
	...
	IntPtr _Result = Natives.fpixaCreate(
  n);
...
public static FPixa fpixaCopy(
	...
	IntPtr _Result = Natives.fpixaCopy(
fpixa.Pointer,   copyflag);
...
public static int fpixaAddFPix(
	...
	int _Result = Natives.fpixaAddFPix(
fpixa.Pointer, fpix.Pointer,   copyflag);
...
public static int fpixaGetCount(
	...
	int _Result = Natives.fpixaGetCount(
fpixa.Pointer);
...
public static int fpixaChangeRefcount(
	...
	int _Result = Natives.fpixaChangeRefcount(
fpixa.Pointer,   delta);
...
public static FPix fpixaGetFPix(
	...
	IntPtr _Result = Natives.fpixaGetFPix(
fpixa.Pointer,   index,   accesstype);
...
public static int fpixaGetFPixDimensions(
	...
	int _Result = Natives.fpixaGetFPixDimensions(
fpixa.Pointer,   index, out  pw, out  ph);
...
public static Single[] fpixaGetData(
	...
	Single[] _Result = Natives.fpixaGetData(
fpixa.Pointer,   index);
...
public static int fpixaGetPixel(
	...
	int _Result = Natives.fpixaGetPixel(
fpixa.Pointer,   index,   x,   y, out  pval);
...
public static int fpixaSetPixel(
	...
	int _Result = Natives.fpixaSetPixel(
fpixa.Pointer,   index,   x,   y,   val);
...
public static DPix dpixCreate(
	...
	IntPtr _Result = Natives.dpixCreate(
  width,   height);
...
public static DPix dpixCreateTemplate(
	...
	IntPtr _Result = Natives.dpixCreateTemplate(
dpixs.Pointer);
...
public static DPix dpixClone(
	...
	IntPtr _Result = Natives.dpixClone(
dpix.Pointer);
...
public static DPix dpixCopy(
	...
	IntPtr _Result = Natives.dpixCopy(
dpixdPtr, dpixs.Pointer);
...
public static int dpixResizeImageData(
	...
	int _Result = Natives.dpixResizeImageData(
dpixd.Pointer, dpixs.Pointer);
...
public static int dpixGetDimensions(
	...
	int _Result = Natives.dpixGetDimensions(
dpix.Pointer, out  pw, out  ph);
...
public static int dpixSetDimensions(
	...
	int _Result = Natives.dpixSetDimensions(
dpix.Pointer,   w,   h);
...
public static int dpixGetWpl(
	...
	int _Result = Natives.dpixGetWpl(
dpix.Pointer);
...
public static int dpixSetWpl(
	...
	int _Result = Natives.dpixSetWpl(
dpix.Pointer,   wpl);
...
public static int dpixGetRefcount(
	...
	int _Result = Natives.dpixGetRefcount(
dpix.Pointer);
...
public static int dpixChangeRefcount(
	...
	int _Result = Natives.dpixChangeRefcount(
dpix.Pointer,   delta);
...
public static int dpixGetResolution(
	...
	int _Result = Natives.dpixGetResolution(
dpix.Pointer, out  pxres, out  pyres);
...
public static int dpixSetResolution(
	...
	int _Result = Natives.dpixSetResolution(
dpix.Pointer,   xres,   yres);
...
public static int dpixCopyResolution(
	...
	int _Result = Natives.dpixCopyResolution(
dpixd.Pointer, dpixs.Pointer);
...
public static Double[] dpixGetData(
	...
	Double[] _Result = Natives.dpixGetData(
dpix.Pointer);
...
public static int dpixSetData(
	...
	int _Result = Natives.dpixSetData(
dpix.Pointer,   data);
...
public static int dpixGetPixel(
	...
	int _Result = Natives.dpixGetPixel(
dpix.Pointer,   x,   y, out  pval);
...
public static int dpixSetPixel(
	...
	int _Result = Natives.dpixSetPixel(
dpix.Pointer,   x,   y,   val);
...
public static FPix fpixRead(
	...
	IntPtr _Result = Natives.fpixRead(
  filename);
...
public static FPix fpixReadStream(
	...
	IntPtr _Result = Natives.fpixReadStream(
fp.Pointer);
...
public static FPix fpixReadMem(
	...
	IntPtr _Result = Natives.fpixReadMem(
  data,   size);
...
public static int fpixWrite(
	...
	int _Result = Natives.fpixWrite(
  filename, fpix.Pointer);
...
public static int fpixWriteStream(
	...
	int _Result = Natives.fpixWriteStream(
fp.Pointer, fpix.Pointer);
...
public static int fpixWriteMem(
	...
	int _Result = Natives.fpixWriteMem(
out  pdataPtr, out  psize, fpix.Pointer);
...
public static FPix fpixEndianByteSwap(
	...
	IntPtr _Result = Natives.fpixEndianByteSwap(
fpixd.Pointer, fpixs.Pointer);
...
public static DPix dpixRead(
	...
	IntPtr _Result = Natives.dpixRead(
  filename);
...
public static DPix dpixReadStream(
	...
	IntPtr _Result = Natives.dpixReadStream(
fp.Pointer);
...
public static DPix dpixReadMem(
	...
	IntPtr _Result = Natives.dpixReadMem(
  data,   size);
...
public static int dpixWrite(
	...
	int _Result = Natives.dpixWrite(
  filename, dpix.Pointer);
...
public static int dpixWriteStream(
	...
	int _Result = Natives.dpixWriteStream(
fp.Pointer, dpix.Pointer);
...
public static int dpixWriteMem(
	...
	int _Result = Natives.dpixWriteMem(
out  pdataPtr, out  psize, dpix.Pointer);
...
public static DPix dpixEndianByteSwap(
	...
	IntPtr _Result = Natives.dpixEndianByteSwap(
dpixd.Pointer, dpixs.Pointer);
...
public static int fpixPrintStream(
	...
	int _Result = Natives.fpixPrintStream(
fp.Pointer, fpix.Pointer,   factor);
