...
public static L_Heap lheapCreate(
	...
	IntPtr _Result = Natives.lheapCreate(
  nalloc,   direction);
...
public static Object lheapRemove(
	...
	IntPtr _Result = Natives.lheapRemove(
lh.Pointer);
...
public static int lheapGetCount(
	...
	int _Result = Natives.lheapGetCount(
lh.Pointer);
...
public static int lheapSwapUp(
	...
	int _Result = Natives.lheapSwapUp(
lh.Pointer,   index);
...
public static int lheapSwapDown(
	...
	int _Result = Natives.lheapSwapDown(
lh.Pointer);
...
public static int lheapSortStrictOrder(
	...
	int _Result = Natives.lheapSortStrictOrder(
lh.Pointer);
...
public static int lheapPrint(
	...
	int _Result = Natives.lheapPrint(
fp.Pointer, lh.Pointer);
