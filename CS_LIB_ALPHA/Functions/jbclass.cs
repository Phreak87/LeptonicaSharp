...
public static JbClasser jbRankHausInit(
	...
	IntPtr _Result = Natives.jbRankHausInit(
  components,   maxwidth,   maxheight,   size,   rank);
...
public static JbClasser jbCorrelationInit(
	...
	IntPtr _Result = Natives.jbCorrelationInit(
  components,   maxwidth,   maxheight,   thresh,   weightfactor);
...
public static JbClasser jbCorrelationInitWithoutComponents(
	...
	IntPtr _Result = Natives.jbCorrelationInitWithoutComponents(
  components,   maxwidth,   maxheight,   thresh,   weightfactor);
...
public static int jbAddPages(
	...
	int _Result = Natives.jbAddPages(
classer.Pointer, safiles.Pointer);
...
public static int jbAddPage(
	...
	int _Result = Natives.jbAddPage(
classer.Pointer, pixs.Pointer);
...
public static int jbAddPageComponents(
	...
	int _Result = Natives.jbAddPageComponents(
classer.Pointer, pixs.Pointer, boxas.Pointer, pixas.Pointer);
...
public static int jbClassifyRankHaus(
	...
	int _Result = Natives.jbClassifyRankHaus(
classer.Pointer, boxa.Pointer, pixas.Pointer);
...
public static int pixHaustest(
	...
	int _Result = Natives.pixHaustest(
pix1.Pointer, pix2.Pointer, pix3.Pointer, pix4.Pointer,   delx,   dely,   maxdiffw,   maxdiffh);
...
public static int pixRankHaustest(
	...
	int _Result = Natives.pixRankHaustest(
pix1.Pointer, pix2.Pointer, pix3.Pointer, pix4.Pointer,   delx,   dely,   maxdiffw,   maxdiffh,   area1,   area3,   rank,   tab8);
...
public static int jbClassifyCorrelation(
	...
	int _Result = Natives.jbClassifyCorrelation(
classer.Pointer, boxa.Pointer, pixas.Pointer);
...
public static int jbGetComponents(
	...
	int _Result = Natives.jbGetComponents(
pixs.Pointer,   components,   maxwidth,   maxheight, pboxadPtr, ppixadPtr);
...
public static int pixWordMaskByDilation(
	...
	int _Result = Natives.pixWordMaskByDilation(
pixs.Pointer, ppixmPtr, out  psize, out pixadbPtr);
...
public static int pixWordBoxesByDilation(
	...
	int _Result = Natives.pixWordBoxesByDilation(
pixs.Pointer,   minwidth,   minheight,   maxwidth,   maxheight, out pboxaPtr, out  psize, out pixadbPtr);
...
public static Pixa jbAccumulateComposites(
	...
	IntPtr _Result = Natives.jbAccumulateComposites(
pixaa.Pointer, pnaPtr, out pptatPtr);
...
public static Pixa jbTemplatesFromComposites(
	...
	IntPtr _Result = Natives.jbTemplatesFromComposites(
pixac.Pointer, na.Pointer);
...
public static JbClasser jbClasserCreate(
	...
	IntPtr _Result = Natives.jbClasserCreate(
  method,   components);
...
public static JbData jbDataSave(
	...
	IntPtr _Result = Natives.jbDataSave(
classer.Pointer);
...
public static int jbDataWrite(
	...
	int _Result = Natives.jbDataWrite(
  rootout, jbdata.Pointer);
...
public static JbData jbDataRead(
	...
	IntPtr _Result = Natives.jbDataRead(
  rootname);
...
public static Pixa jbDataRender(
	...
	IntPtr _Result = Natives.jbDataRender(
data.Pointer,   debugflag);
...
public static int jbGetULCorners(
	...
	int _Result = Natives.jbGetULCorners(
classer.Pointer, pixs.Pointer, boxa.Pointer);
...
public static int jbGetLLCorners(
	...
	int _Result = Natives.jbGetLLCorners(
classer.Pointer);
