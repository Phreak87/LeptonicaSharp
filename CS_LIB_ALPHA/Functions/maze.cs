...
public static Pix generateBinaryMaze(
	...
	IntPtr _Result = Natives.generateBinaryMaze(
  w,   h,   xi,   yi,   wallps,   ranis);
...
public static Pta pixSearchBinaryMaze(
	...
	IntPtr _Result = Natives.pixSearchBinaryMaze(
pixs.Pointer,   xi,   yi,   xf,   yf, out ppixdPtr);
...
public static Pta pixSearchGrayMaze(
	...
	IntPtr _Result = Natives.pixSearchGrayMaze(
pixs.Pointer,   xi,   yi,   xf,   yf, out ppixdPtr);
