...
public static Numa numaArithOp(
	...
	IntPtr _Result = Natives.numaArithOp(
nadPtr, na1.Pointer, na2.Pointer,   op);
...
public static Numa numaLogicalOp(
	...
	IntPtr _Result = Natives.numaLogicalOp(
nadPtr, na1.Pointer, na2.Pointer,   op);
...
public static Numa numaInvert(
	...
	IntPtr _Result = Natives.numaInvert(
nadPtr, nas.Pointer);
...
public static int numaSimilar(
	...
	int _Result = Natives.numaSimilar(
na1.Pointer, na2.Pointer,   maxdiff, out  psimilar);
...
public static int numaAddToNumber(
	...
	int _Result = Natives.numaAddToNumber(
na.Pointer,   index,   val);
...
public static int numaGetMin(
	...
	int _Result = Natives.numaGetMin(
na.Pointer, out  pminval, out  piminloc);
...
public static int numaGetMax(
	...
	int _Result = Natives.numaGetMax(
na.Pointer, out  pmaxval, out  pimaxloc);
...
public static int numaGetSum(
	...
	int _Result = Natives.numaGetSum(
na.Pointer, out  psum);
...
public static Numa numaGetPartialSums(
	...
	IntPtr _Result = Natives.numaGetPartialSums(
na.Pointer);
...
public static int numaGetSumOnInterval(
	...
	int _Result = Natives.numaGetSumOnInterval(
na.Pointer,   first,   last, out  psum);
...
public static int numaHasOnlyIntegers(
	...
	int _Result = Natives.numaHasOnlyIntegers(
na.Pointer,   maxsamples, out  pallints);
...
public static Numa numaSubsample(
	...
	IntPtr _Result = Natives.numaSubsample(
nas.Pointer,   subfactor);
...
public static Numa numaMakeDelta(
	...
	IntPtr _Result = Natives.numaMakeDelta(
nas.Pointer);
...
public static Numa numaMakeSequence(
	...
	IntPtr _Result = Natives.numaMakeSequence(
  startval,   increment,   size);
...
public static Numa numaMakeConstant(
	...
	IntPtr _Result = Natives.numaMakeConstant(
  val,   size);
...
public static Numa numaMakeAbsValue(
	...
	IntPtr _Result = Natives.numaMakeAbsValue(
nadPtr, nas.Pointer);
...
public static Numa numaAddBorder(
	...
	IntPtr _Result = Natives.numaAddBorder(
nas.Pointer,   left,   right,   val);
...
public static Numa numaAddSpecifiedBorder(
	...
	IntPtr _Result = Natives.numaAddSpecifiedBorder(
nas.Pointer,   left,   right,   type);
...
public static Numa numaRemoveBorder(
	...
	IntPtr _Result = Natives.numaRemoveBorder(
nas.Pointer,   left,   right);
...
public static int numaCountNonzeroRuns(
	...
	int _Result = Natives.numaCountNonzeroRuns(
na.Pointer, out  pcount);
...
public static int numaGetNonzeroRange(
	...
	int _Result = Natives.numaGetNonzeroRange(
na.Pointer,   eps, out  pfirst, out  plast);
...
public static int numaGetCountRelativeToZero(
	...
	int _Result = Natives.numaGetCountRelativeToZero(
na.Pointer,   type, out  pcount);
...
public static Numa numaClipToInterval(
	...
	IntPtr _Result = Natives.numaClipToInterval(
nas.Pointer,   first,   last);
...
public static Numa numaMakeThresholdIndicator(
	...
	IntPtr _Result = Natives.numaMakeThresholdIndicator(
nas.Pointer,   thresh,   type);
...
public static Numa numaUniformSampling(
	...
	IntPtr _Result = Natives.numaUniformSampling(
nas.Pointer,   nsamp);
...
public static Numa numaReverse(
	...
	IntPtr _Result = Natives.numaReverse(
nadPtr, nas.Pointer);
...
public static Numa numaLowPassIntervals(
	...
	IntPtr _Result = Natives.numaLowPassIntervals(
nas.Pointer,   thresh,   maxn);
...
public static Numa numaThresholdEdges(
	...
	IntPtr _Result = Natives.numaThresholdEdges(
nas.Pointer,   thresh1,   thresh2,   maxn);
...
public static int numaGetSpanValues(
	...
	int _Result = Natives.numaGetSpanValues(
na.Pointer,   span, out  pstart, out  pend);
...
public static int numaGetEdgeValues(
	...
	int _Result = Natives.numaGetEdgeValues(
na.Pointer,   edge, out  pstart, out  pend, out  psign);
...
public static int numaInterpolateEqxVal(
	...
	int _Result = Natives.numaInterpolateEqxVal(
  startx,   deltax, nay.Pointer,   type,   xval, out  pyval);
...
public static int numaInterpolateArbxVal(
	...
	int _Result = Natives.numaInterpolateArbxVal(
nax.Pointer, nay.Pointer,   type,   xval, out  pyval);
...
public static int numaInterpolateEqxInterval(
	...
	int _Result = Natives.numaInterpolateEqxInterval(
  startx,   deltax, nasy.Pointer,   type,   x0,   x1,   npts, out pnaxPtr, out pnayPtr);
...
public static int numaInterpolateArbxInterval(
	...
	int _Result = Natives.numaInterpolateArbxInterval(
nax.Pointer, nay.Pointer,   type,   x0,   x1,   npts, out pnadxPtr, out pnadyPtr);
...
public static int numaFitMax(
	...
	int _Result = Natives.numaFitMax(
na.Pointer, out  pmaxval, nalocPtr, out  pmaxloc);
...
public static int numaDifferentiateInterval(
	...
	int _Result = Natives.numaDifferentiateInterval(
nax.Pointer, nay.Pointer,   x0,   x1,   npts, out pnadxPtr, out pnadyPtr);
...
public static int numaIntegrateInterval(
	...
	int _Result = Natives.numaIntegrateInterval(
nax.Pointer, nay.Pointer,   x0,   x1,   npts, out  psum);
...
public static int numaSortGeneral(
	...
	int _Result = Natives.numaSortGeneral(
na.Pointer, out pnasortPtr, out pnaindexPtr, out pnainvertPtr,   sortorder,   sorttype);
...
public static Numa numaSortAutoSelect(
	...
	IntPtr _Result = Natives.numaSortAutoSelect(
nas.Pointer,   sortorder);
...
public static Numa numaSortIndexAutoSelect(
	...
	IntPtr _Result = Natives.numaSortIndexAutoSelect(
nas.Pointer,   sortorder);
...
public static int numaChooseSortType(
	...
	int _Result = Natives.numaChooseSortType(
nas.Pointer);
...
public static Numa numaSort(
	...
	IntPtr _Result = Natives.numaSort(
naout.Pointer, nain.Pointer,   sortorder);
...
public static Numa numaBinSort(
	...
	IntPtr _Result = Natives.numaBinSort(
nas.Pointer,   sortorder);
...
public static Numa numaGetSortIndex(
	...
	IntPtr _Result = Natives.numaGetSortIndex(
na.Pointer,   sortorder);
...
public static Numa numaGetBinSortIndex(
	...
	IntPtr _Result = Natives.numaGetBinSortIndex(
nas.Pointer,   sortorder);
...
public static Numa numaSortByIndex(
	...
	IntPtr _Result = Natives.numaSortByIndex(
nas.Pointer, naindex.Pointer);
...
public static int numaIsSorted(
	...
	int _Result = Natives.numaIsSorted(
nas.Pointer,   sortorder, out  psorted);
...
public static int numaSortPair(
	...
	int _Result = Natives.numaSortPair(
nax.Pointer, nay.Pointer,   sortorder, out pnasxPtr, out pnasyPtr);
...
public static Numa numaInvertMap(
	...
	IntPtr _Result = Natives.numaInvertMap(
nas.Pointer);
...
public static Numa numaPseudorandomSequence(
	...
	IntPtr _Result = Natives.numaPseudorandomSequence(
  size,   seed);
...
public static Numa numaRandomPermutation(
	...
	IntPtr _Result = Natives.numaRandomPermutation(
nas.Pointer,   seed);
...
public static int numaGetRankValue(
	...
	int _Result = Natives.numaGetRankValue(
na.Pointer,   fract, nasortPtr,   usebins, out  pval);
...
public static int numaGetMedian(
	...
	int _Result = Natives.numaGetMedian(
na.Pointer, out  pval);
...
public static int numaGetBinnedMedian(
	...
	int _Result = Natives.numaGetBinnedMedian(
na.Pointer, out  pval);
...
public static int numaGetMode(
	...
	int _Result = Natives.numaGetMode(
na.Pointer, out  pval, out  pcount);
...
public static int numaGetMedianVariation(
	...
	int _Result = Natives.numaGetMedianVariation(
na.Pointer, out  pmedval, out  pmedvar);
...
public static int numaJoin(
	...
	int _Result = Natives.numaJoin(
nad.Pointer, nasPtr,   istart,   iend);
...
public static int numaaJoin(
	...
	int _Result = Natives.numaaJoin(
naad.Pointer, naasPtr,   istart,   iend);
...
public static Numa numaaFlattenToNuma(
	...
	IntPtr _Result = Natives.numaaFlattenToNuma(
naa.Pointer);
