...
public static Pix pixProjectiveSampledPta(
	...
	IntPtr _Result = Natives.pixProjectiveSampledPta(
...
public static Pix pixProjectiveSampled(
	...
	IntPtr _Result = Natives.pixProjectiveSampled(
...
public static Pix pixProjectivePta(
	...
	IntPtr _Result = Natives.pixProjectivePta(
pixs.Pointer, ptad.Pointer, ptas.Pointer,   incolor);
...
public static Pix pixProjective(
	...
	IntPtr _Result = Natives.pixProjective(
pixs.Pointer,   vc,   incolor);
...
public static Pix pixProjectivePtaColor(
	...
	IntPtr _Result = Natives.pixProjectivePtaColor(
...
public static Pix pixProjectiveColor(
	...
	IntPtr _Result = Natives.pixProjectiveColor(
...
public static Pix pixProjectivePtaGray(
	...
	IntPtr _Result = Natives.pixProjectivePtaGray(
...
public static Pix pixProjectiveGray(
	...
	IntPtr _Result = Natives.pixProjectiveGray(
...
public static Pix pixProjectivePtaWithAlpha(
	...
	IntPtr _Result = Natives.pixProjectivePtaWithAlpha(
...
public static int getProjectiveXformCoeffs(
	...
	int _Result = Natives.getProjectiveXformCoeffs(
...
public static int projectiveXformSampledPt(
	...
	int _Result = Natives.projectiveXformSampledPt(
...
public static int projectiveXformPt(
	...
	int _Result = Natives.projectiveXformPt(
  vc,   x,   y, out  pxp, out  pyp);
