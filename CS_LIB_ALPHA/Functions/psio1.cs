...
public static int convertFilesToPS(
	...
	int _Result = Natives.convertFilesToPS(
  dirin,   substr,   res,   fileout);
...
public static int sarrayConvertFilesToPS(
	...
	int _Result = Natives.sarrayConvertFilesToPS(
sa.Pointer,   res,   fileout);
...
public static int convertFilesFittedToPS(
	...
	int _Result = Natives.convertFilesFittedToPS(
  dirin,   substr,   xpts,   ypts,   fileout);
...
public static int sarrayConvertFilesFittedToPS(
	...
	int _Result = Natives.sarrayConvertFilesFittedToPS(
sa.Pointer,   xpts,   ypts,   fileout);
...
public static int writeImageCompressedToPSFile(
	...
	int _Result = Natives.writeImageCompressedToPSFile(
  filein,   fileout,   res,   pfirstfile,   pindex);
...
public static int convertSegmentedPagesToPS(
	...
	int _Result = Natives.convertSegmentedPagesToPS(
  pagedir,   pagestr,   page_numpre,   maskdir,   maskstr,   mask_numpre,   numpost,   maxnum,   textscale,   imagescale,   threshold,   fileout);
...
public static int pixWriteSegmentedPageToPS(
	...
	int _Result = Natives.pixWriteSegmentedPageToPS(
pixs.Pointer, pixm.Pointer,   textscale,   imagescale,   threshold,   pageno,   fileout);
...
public static int pixWriteMixedToPS(
	...
	int _Result = Natives.pixWriteMixedToPS(
pixb.Pointer, pixc.Pointer,   scale,   pageno,   fileout);
...
public static int convertToPSEmbed(
	...
	int _Result = Natives.convertToPSEmbed(
  filein,   fileout,   level);
...
public static int pixaWriteCompressedToPS(
	...
	int _Result = Natives.pixaWriteCompressedToPS(
pixa.Pointer,   fileout,   res,   level);
