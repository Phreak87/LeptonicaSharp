...
public static L_WShed wshedCreate(
	...
	IntPtr _Result = Natives.wshedCreate(
pixs.Pointer, pixm.Pointer,   mindepth,   debugflag);
...
public static int wshedApply(
	...
	int _Result = Natives.wshedApply(
wshed.Pointer);
...
public static int wshedBasins(
	...
	int _Result = Natives.wshedBasins(
wshed.Pointer, out ppixaPtr, out pnalevelsPtr);
...
public static Pix wshedRenderFill(
	...
	IntPtr _Result = Natives.wshedRenderFill(
wshed.Pointer);
...
public static Pix wshedRenderColors(
	...
	IntPtr _Result = Natives.wshedRenderColors(
wshed.Pointer);
