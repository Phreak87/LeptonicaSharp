...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixAffineSampledPta(pixs.Pointer, ptad.Pointer, ptas.Pointer,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixAffineSampled(pixs.Pointer,   vc,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (ptad) then Throw New ArgumentNullException  ("ptad cannot be Nothing")
		if IsNothing (ptas) then Throw New ArgumentNullException  ("ptas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAffinePta(pixs.Pointer, ptad.Pointer, ptas.Pointer,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAffine(pixs.Pointer,   vc,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (ptad) then Throw New ArgumentNullException  ("ptad cannot be Nothing")
		if IsNothing (ptas) then Throw New ArgumentNullException  ("ptas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAffinePtaColor(pixs.Pointer, ptad.Pointer, ptas.Pointer,   colorval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAffineColor(pixs.Pointer,   vc,   colorval)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as IntPtr = Natives.pixAffinePtaGray(pixs.Pointer, ptad.Pointer, ptas.Pointer,   grayval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as IntPtr = Natives.pixAffineGray(pixs.Pointer,   vc,   grayval)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as IntPtr = Natives.pixAffinePtaWithAlpha(pixs.Pointer, ptad.Pointer, ptas.Pointer, pixgPtr,   fract,   border)
...
if IsNothing (ptas) then Throw New ArgumentNullException  ("ptas cannot be Nothing")
		if IsNothing (ptad) then Throw New ArgumentNullException  ("ptad cannot be Nothing")
	Dim pvcPtr as IntPtr = IntPtr.Zero

	Dim _Result as Integer = Natives.getAffineXformCoeffs(ptas.Pointer, ptad.Pointer,   pvcPtr)
	
	if IsNothing(pvc) then pvc = nothing else pvc = pvc
	return _Result
End Function
...
if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim pvciPtr as IntPtr = IntPtr.Zero

	Dim _Result as Integer = Natives.affineInvertXform(  vc,   pvciPtr)
	
	if IsNothing(pvci) then pvci = nothing else pvci = pvci
	return _Result
End Function
...
if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as Integer = Natives.affineXformSampledPt(  vc,   x,   y,   pxp,   pyp)
...
if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as Integer = Natives.affineXformPt(  vc,   x,   y,   pxp,   pyp)
...
if IsNothing (datas) then Throw New ArgumentNullException  ("datas cannot be Nothing")
	...
	Dim _Result as Integer = Natives.linearInterpolatePixelColor(  datasPtr,   wpls,   w,   h,   x,   y,   colorval,   pval)
...
if IsNothing (datas) then Throw New ArgumentNullException  ("datas cannot be Nothing")
	...
	Dim _Result as Integer = Natives.linearInterpolatePixelGray(  datasPtr,   wpls,   w,   h,   x,   y,   grayval,   pval)
...
if IsNothing (a) then Throw New ArgumentNullException  ("a cannot be Nothing")
	...
	Dim aPtr as IntPtr = Marshal.AllocHGlobal(a.Count)

	Dim _Result as Integer = Natives.gaussjordan(  aPtr,   b,   n)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (ptad) then Throw New ArgumentNullException  ("ptad cannot be Nothing")
		if IsNothing (ptas) then Throw New ArgumentNullException  ("ptas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAffineSequential(pixs.Pointer, ptad.Pointer, ptas.Pointer,   bw,   bh)
