...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixBilinearSampledPta(pixs.Pointer, ptad.Pointer, ptas.Pointer,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixBilinearSampled(pixs.Pointer,   vc,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (ptad) then Throw New ArgumentNullException  ("ptad cannot be Nothing")
		if IsNothing (ptas) then Throw New ArgumentNullException  ("ptas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixBilinearPta(pixs.Pointer, ptad.Pointer, ptas.Pointer,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixBilinear(pixs.Pointer,   vc,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (ptad) then Throw New ArgumentNullException  ("ptad cannot be Nothing")
		if IsNothing (ptas) then Throw New ArgumentNullException  ("ptas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixBilinearPtaColor(pixs.Pointer, ptad.Pointer, ptas.Pointer,   colorval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixBilinearColor(pixs.Pointer,   vc,   colorval)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as IntPtr = Natives.pixBilinearPtaGray(pixs.Pointer, ptad.Pointer, ptas.Pointer,   grayval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as IntPtr = Natives.pixBilinearGray(pixs.Pointer,   vc,   grayval)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as IntPtr = Natives.pixBilinearPtaWithAlpha(pixs.Pointer, ptad.Pointer, ptas.Pointer, pixgPtr,   fract,   border)
...
if IsNothing (ptas) then Throw New ArgumentNullException  ("ptas cannot be Nothing")
	...
	Dim _Result as Integer = Natives.getBilinearXformCoeffs(ptas.Pointer, ptad.Pointer,   pvcPtr)
...
if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as Integer = Natives.bilinearXformSampledPt(  vc,   x,   y,   pxp,   pyp)
...
if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as Integer = Natives.bilinearXformPt(  vc,   x,   y,   pxp,   pyp)
