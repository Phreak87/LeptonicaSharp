...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixReduceBinary2(pixs.Pointer,   intab)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixReduceRankBinaryCascade(pixs.Pointer,   level1,   level2,   level3,   level4)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixReduceRankBinary2(pixs.Pointer,   level,   intab)
...
Public Shared Function makeSubsampleTab2x() as Byte()
	...
	Dim _Result as Byte() = Natives.makeSubsampleTab2x()
