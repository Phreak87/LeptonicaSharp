...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixBlend(pixs1.Pointer, pixs2.Pointer,   x,   y,   fract)
...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixBlendMask(pixdPtr, pixs1.Pointer, pixs2.Pointer,   x,   y,   fract,   type)
...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixBlendGray(pixdPtr, pixs1.Pointer, pixs2.Pointer,   x,   y,   fract,   type,   transparent,   transpix)
...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixBlendGrayInverse(pixdPtr, pixs1.Pointer, pixs2.Pointer,   x,   y,   fract)
...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixBlendColor(pixdPtr, pixs1.Pointer, pixs2.Pointer,   x,   y,   fract,   transparent,   transpix)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixBlendColorByChannel(pixd.Pointer, pixs1.Pointer, pixs2.Pointer,   x,   y,   rfract,   gfract,   bfract,   transparent,   transpix)
...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixBlendGrayAdapt(pixdPtr, pixs1.Pointer, pixs2.Pointer,   x,   y,   fract,   shift)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixFadeWithGray(pixs.Pointer, pixb.Pointer,   factor,   type)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixBlendHardLight(pixd.Pointer, pixs1.Pointer, pixs2.Pointer,   x,   y,   fract)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (pixb) then Throw New ArgumentNullException  ("pixb cannot be Nothing")
	Dim _Result as Integer = Natives.pixBlendCmap(pixs.Pointer, pixb.Pointer,   x,   y,   sindex)
...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixBlendWithGrayMask(pixs1.Pointer, pixs2.Pointer, pixgPtr,   x,   y)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as IntPtr = Natives.pixBlendBackgroundToColor(pixdPtr, pixs.Pointer, box.Pointer,   color,   gamma,   minval,   maxval)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as IntPtr = Natives.pixMultiplyByColor(pixdPtr, pixs.Pointer, box.Pointer,   color)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAlphaBlendUniform(pixs.Pointer,   color)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAddAlphaToBlend(pixs.Pointer,   fract,   invert)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixSetAlphaOverWhite(pixs.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixLinearEdgeFade(pixs.Pointer,   dir,   fadeto,   distfract,   maxfade)
