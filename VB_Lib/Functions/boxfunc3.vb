...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixMaskConnComp(pixs.Pointer,   connectivity, pboxaPtr)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixMaskBoxa(pixdPtr, pixs.Pointer, boxa.Pointer,   op)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixPaintBoxa(pixs.Pointer, boxa.Pointer,   val)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixSetBlackOrWhiteBoxa(pixs.Pointer, boxaPtr,   op)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixPaintBoxaRandom(pixs.Pointer, boxa.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixBlendBoxaRandom(pixs.Pointer, boxa.Pointer,   fract)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixDrawBoxa(pixs.Pointer, boxa.Pointer,   width,   val)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixDrawBoxaRandom(pixs.Pointer, boxa.Pointer,   width)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.boxaaDisplay(pixsPtr, baa.Pointer,   linewba,   linewb,   colorba,   colorb,   w,   h)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
		if IsNothing (baa) then Throw New ArgumentNullException  ("baa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaDisplayBoxaa(pixas.Pointer, baa.Pointer,   colorflag,   width)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixSplitIntoBoxa(pixs.Pointer,   minsum,   skipdist,   delta,   maxbg,   maxcomps,   remainder)
...
If {1}.contains (pix.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixSplitComponentIntoBoxa(pix.Pointer, boxPtr,   minsum,   skipdist,   delta,   maxbg,   maxcomps,   remainder)
...
Public Shared Function makeMosaicStrips(
	...
	Dim _Result as IntPtr = Natives.makeMosaicStrips(  w,   h,   direction,   size)
...
Public Shared Function boxaCompareRegions(
				...
				<Out()> Optional  ByRef pdiffxor as Single = 0f, 
...
if IsNothing (boxa1) then Throw New ArgumentNullException  ("boxa1 cannot be Nothing")
	...
	Dim _Result as Integer = Natives.boxaCompareRegions(boxa1.Pointer, boxa2.Pointer,   areathresh,   pnsame,   pdiffarea,   pdiffxor, ppixdbPtr)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixSelectLargeULComp(pixs.Pointer,   areaslop,   yslop,   connectivity)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaSelectLargeULBox(boxas.Pointer,   areaslop,   yslop)
