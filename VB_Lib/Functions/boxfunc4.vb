...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaSelectRange(boxas.Pointer,   first,   last,   copyflag)
...
if IsNothing (baas) then Throw New ArgumentNullException  ("baas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaaSelectRange(baas.Pointer,   first,   last,   copyflag)
...
Public Shared Function boxaSelectBySize(
				...
				<Out()> Optional  ByRef pchanged as Integer = 0) as Boxa


if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaSelectBySize(boxas.Pointer,   width,   height,   type,   relation,   pchanged)
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaMakeSizeIndicator(boxa.Pointer,   width,   height,   type,   relation)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaSelectByArea(boxas.Pointer,   area,   relation,   pchanged)
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaMakeAreaIndicator(boxa.Pointer,   area,   relation)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaSelectByWHRatio(boxas.Pointer,   ratio,   relation,   pchanged)
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaMakeWHRatioIndicator(boxa.Pointer,   ratio,   relation)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.boxaSelectWithIndicator(boxas.Pointer, na.Pointer,   pchanged)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaPermutePseudorandom(boxas.Pointer)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.boxaPermuteRandom(boxadPtr, boxas.Pointer)
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as Integer = Natives.boxaSwapBoxes(boxa.Pointer,   i,   j)
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaConvertToPta(boxa.Pointer,   ncorners)
...
if IsNothing (pta) then Throw New ArgumentNullException  ("pta cannot be Nothing")
	Dim _Result as IntPtr = Natives.ptaConvertToBoxa(pta.Pointer,   ncorners)
...
if IsNothing (box) then Throw New ArgumentNullException  ("box cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxConvertToPta(box.Pointer,   ncorners)
...
if IsNothing (pta) then Throw New ArgumentNullException  ("pta cannot be Nothing")
	Dim _Result as IntPtr = Natives.ptaConvertToBox(pta.Pointer)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaSmoothSequenceLS(boxas.Pointer,   factor,   subflag,   maxdiff,   extrapixels,   debug)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaSmoothSequenceMedian(boxas.Pointer,   halfwin,   subflag,   maxdiff,   extrapixels,   debug)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaLinearFit(boxas.Pointer,   factor,   debug)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaWindowedMedian(boxas.Pointer,   halfwin,   debug)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.boxaModifyWithBoxa(boxas.Pointer, boxam.Pointer,   subflag,   maxdiff,   extrapixels)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaConstrainSize(boxas.Pointer,   width,   widthflag,   height,   heightflag)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaReconcileEvenOddHeight(boxas.Pointer,   sides,   delh,   op,   factor,   start)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.boxaReconcilePairWidth(boxas.Pointer,   delw,   op,   factor, naPtr)
...
Public Shared Function boxaPlotSides(
				ByVal boxa as Boxa, 
				Optional ByVal plotname as String = "", 
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.boxaPlotSides(boxa.Pointer,   plotname, pnalPtr, pnatPtr, pnarPtr, pnabPtr, ppixdPtr)
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.boxaPlotSizes(boxa.Pointer,   plotname, pnawPtr, pnahPtr, ppixdPtr)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaFillSequence(boxas.Pointer,   useflag,   debug)
...
Public Shared Function boxaSizeVariation(
				ByVal boxa as Boxa, 
				ByVal type as Enumerations.L_SELECT, 
				<Out()> Optional  ByRef pdel_evenodd as Single = 0f, 
				<Out()> Optional  ByRef prms_even as Single = 0f, 
				<Out()> Optional  ByRef prms_odd as Single = 0f, 
				<Out()> Optional  ByRef prms_all as Single = 0f) as Integer


if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as Integer = Natives.boxaSizeVariation(boxa.Pointer,   type,   pdel_evenodd,   prms_even,   prms_odd,   prms_all)
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.boxaGetExtent(boxa.Pointer,   pw,   ph, pboxPtr)
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as Integer = Natives.boxaGetCoverage(boxa.Pointer,   wc,   hc,   exactflag,   pfract)
...
if IsNothing (baa) then Throw New ArgumentNullException  ("baa cannot be Nothing")
	Dim _Result as Integer = Natives.boxaaSizeRange(baa.Pointer,   pminw,   pminh,   pmaxw,   pmaxh)
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as Integer = Natives.boxaSizeRange(boxa.Pointer,   pminw,   pminh,   pmaxw,   pmaxh)
...
Public Shared Function boxaLocationRange(
				ByVal boxa as Boxa, 
				<Out()> Optional  ByRef pminx as Integer = 0, 
				<Out()> Optional  ByRef pminy as Integer = 0, 
				<Out()> Optional  ByRef pmaxx as Integer = 0, 
				<Out()> Optional  ByRef pmaxy as Integer = 0) as Integer


if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as Integer = Natives.boxaLocationRange(boxa.Pointer,   pminx,   pminy,   pmaxx,   pmaxy)
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.boxaGetSizes(boxa.Pointer, pnawPtr, pnahPtr)
...
if IsNothing (boxa) then Throw New ArgumentNullException  ("boxa cannot be Nothing")
	Dim _Result as Integer = Natives.boxaGetArea(boxa.Pointer,   parea)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.boxaDisplayTiled(boxas.Pointer, pixaPtr,   maxwidth,   linewidth,   scalefactor,   background,   spacing,   border)
