...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaThinConnected(pixas.Pointer,   type,   connectivity,   maxiters)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixThinConnected(pixs.Pointer,   type,   connectivity,   maxiters)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixThinConnectedBySet(pixs.Pointer,   type, sela.Pointer,   maxiters)
