...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixColorGrayRegions(pixs.Pointer, boxa.Pointer,   type,   thresh,   rval,   gval,   bval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixColorGray(pixs.Pointer, boxPtr,   type,   thresh,   rval,   gval,   bval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixColorGrayMasked(pixs.Pointer, pixm.Pointer,   type,   thresh,   rval,   gval,   bval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixSnapColor(pixdPtr, pixs.Pointer,   srcval,   dstval,   diff)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixSnapColorCmap(pixdPtr, pixs.Pointer,   srcval,   dstval,   diff)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as IntPtr = Natives.pixLinearMapToTargetColor(pixdPtr, pixs.Pointer,   srcval,   dstval)
...
Public Shared Function pixelLinearMapToTargetColor(
	...
	Dim _Result as Integer = Natives.pixelLinearMapToTargetColor(  scolor,   srcmap,   dstmap,   pdcolor)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as IntPtr = Natives.pixShiftByComponent(pixdPtr, pixs.Pointer,   srcval,   dstval)
...
Public Shared Function pixelShiftByComponent(
	...
	Dim _Result as Integer = Natives.pixelShiftByComponent(  rval,   gval,   bval,   srcval,   dstval,   ppixel)
...
Public Shared Function pixelFractionalShift(
	...
	Dim _Result as Integer = Natives.pixelFractionalShift(  rval,   gval,   bval,   fraction,   ppixel)
