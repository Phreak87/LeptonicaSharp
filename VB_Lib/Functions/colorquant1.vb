...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixOctreeColorQuant(pixs.Pointer,   colors,   ditherflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixOctreeColorQuantGeneral(pixs.Pointer,   colors,   ditherflag,   validthresh,   colorthresh)
...
Public Shared Function makeRGBToIndexTables(
	...
	Dim _Result as Integer = Natives.makeRGBToIndexTables(  prtabPtr,   pgtabPtr,   pbtabPtr,   cqlevels)
...
if IsNothing (rtab) then Throw New ArgumentNullException  ("rtab cannot be Nothing")
		...
		Dim rtabPtr as IntPtr = 	Marshal.AllocHGlobal(rtab.Length)
		Marshal.Copy(rtab, 0, rtabPtr, rtab.Length)
		Dim gtabPtr as IntPtr = 	Marshal.AllocHGlobal(gtab.Length)
		Marshal.Copy(gtab, 0, gtabPtr, gtab.Length)
		Dim btabPtr as IntPtr = 	Marshal.AllocHGlobal(btab.Length)
		Marshal.Copy(btab, 0, btabPtr, btab.Length)

	Natives.getOctcubeIndexFromRGB(  rval,   gval,   bval,   rtabPtr,   gtabPtr,   btabPtr,   pindex)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixOctreeQuantByPopulation(pixs.Pointer,   level,   ditherflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixOctreeQuantNumColors(pixs.Pointer,   maxcolors,   subsample)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixOctcubeQuantMixedWithGray(pixs.Pointer,   depth,   graylevels,   delta)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixFixedOctcubeQuant256(pixs.Pointer,   ditherflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixFewColorsOctcubeQuant1(pixs.Pointer,   level)
...
Public Shared Function pixFewColorsOctcubeQuant2(
				...
				<Out()> Optional  ByRef pnerrors as Integer = 0) as Pix


if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixFewColorsOctcubeQuant2(pixs.Pointer,   level, na.Pointer,   ncolors,   pnerrors)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixFewColorsOctcubeQuantMixed(pixs.Pointer,   level,   darkthresh,   lightthresh,   diffthresh,   minfract,   maxspan)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixFixedOctcubeQuantGenRGB(pixs.Pointer,   level)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixQuantFromCmap(pixs.Pointer, cmap.Pointer,   mindepth,   level,   metric)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (cmap) then Throw New ArgumentNullException  ("cmap cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixOctcubeQuantFromCmap(pixs.Pointer, cmap.Pointer,   mindepth,   level,   metric)
...
Public Shared Function pixOctcubeHistogram(
				ByVal pixs as Pix, 
				ByVal level as Integer, 
				<Out()> Optional  ByRef pncolors as Integer = 0) as Numa


if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixOctcubeHistogram(pixs.Pointer,   level,   pncolors)
...
if IsNothing (cmap) then Throw New ArgumentNullException  ("cmap cannot be Nothing")
	Dim _Result as Integer() = Natives.pixcmapToOctcubeLUT(cmap.Pointer,   level,   metric)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixRemoveUnusedColors(pixs.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixNumberOccupiedOctcubes(pix.Pointer,   level,   mincount,   minfract,   pncolors)
