...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixMedianCutQuant(pixs.Pointer,   ditherflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixMedianCutQuantGeneral(pixs.Pointer,   ditherflag,   outdepth,   maxcolors,   sigbits,   maxsub,   checkbw)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixMedianCutQuantMixed(pixs.Pointer,   ncolor,   ngray,   darkthresh,   lightthresh,   diffthresh)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixFewColorsMedianCutQuantMixed(pixs.Pointer,   ncolor,   ngray,   maxncolors,   darkthresh,   lightthresh,   diffthresh)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer() = Natives.pixMedianCutHisto(pixs.Pointer,   sigbits,   subsample)
