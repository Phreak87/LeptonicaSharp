...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixColorSegment(pixs.Pointer,   maxdist,   maxcolors,   selsize,   finalcolors,   debugflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixColorSegmentCluster(pixs.Pointer,   maxdist,   maxcolors,   debugflag)
...
If {1}.contains (pixm.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as Integer = Natives.pixAssignToNearestColor(pixd.Pointer, pixs.Pointer, pixmPtr,   level,   countarray)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixColorSegmentClean(pixs.Pointer,   selsize,   countarray)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
		if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixColorSegmentRemoveColors(pixd.Pointer, pixs.Pointer,   finalcolors)
