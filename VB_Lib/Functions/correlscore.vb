...
if IsNothing (pix1) then Throw New ArgumentNullException  ("pix1 cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixCorrelationScore(pix1.Pointer, pix2.Pointer,   area1,   area2,   delx,   dely,   maxdiffw,   maxdiffh,   tab,   pscore)
...
if IsNothing (pix1) then Throw New ArgumentNullException  ("pix1 cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixCorrelationScoreThresholded(pix1.Pointer, pix2.Pointer,   area1,   area2,   delx,   dely,   maxdiffw,   maxdiffh,   tab,   downcount,   score_threshold)
...
if IsNothing (pix1) then Throw New ArgumentNullException  ("pix1 cannot be Nothing")
		if IsNothing (pix2) then Throw New ArgumentNullException  ("pix2 cannot be Nothing")
		if IsNothing (tab) then Throw New ArgumentNullException  ("tab cannot be Nothing")
	Dim _Result as Integer = Natives.pixCorrelationScoreSimple(pix1.Pointer, pix2.Pointer,   area1,   area2,   delx,   dely,   maxdiffw,   maxdiffh,   tab,   pscore)
...
If {1}.contains (pix1.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as Integer = Natives.pixCorrelationScoreShifted(pix1.Pointer, pix2.Pointer,   area1,   area2,   delx,   dely,   tab,   pscore)
