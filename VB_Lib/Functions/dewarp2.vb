...
Public Shared Function dewarpBuildPageModel(
				...
				Optional ByVal debugfile as String = "") as Integer


if IsNothing (dew) then Throw New ArgumentNullException  ("dew cannot be Nothing")
	Dim _Result as Integer = Natives.dewarpBuildPageModel(dew.Pointer,   debugfile)
...
if IsNothing (dew) then Throw New ArgumentNullException  ("dew cannot be Nothing")
	...
	Dim _Result as Integer = Natives.dewarpFindVertDisparity(dew.Pointer, ptaa.Pointer,   rotflag)
...
if IsNothing (dew) then Throw New ArgumentNullException  ("dew cannot be Nothing")
		if IsNothing (ptaa) then Throw New ArgumentNullException  ("ptaa cannot be Nothing")
	Dim _Result as Integer = Natives.dewarpFindHorizDisparity(dew.Pointer, ptaa.Pointer)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.dewarpGetTextlineCenters(pixs.Pointer,   debugflag)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.dewarpRemoveShortLines(pixs.Pointer, ptaas.Pointer,   fract,   debugflag)
...
if IsNothing (dew) then Throw New ArgumentNullException  ("dew cannot be Nothing")
	...
	Dim _Result as Integer = Natives.dewarpFindHorizSlopeDisparity(dew.Pointer, pixb.Pointer,   fractthresh,   parity)
...
if IsNothing (dew) then Throw New ArgumentNullException  ("dew cannot be Nothing")
	Dim _Result as Integer = Natives.dewarpBuildLineModel(dew.Pointer,   opensize,   debugfile)
...
Public Shared Function dewarpaModelStatus(
				...
				<Out()> Optional  ByRef pvsuccess as Integer = 0, 
				<Out()> Optional  ByRef phsuccess as Integer = 0) as Integer


if IsNothing (dewa) then Throw New ArgumentNullException  ("dewa cannot be Nothing")
	Dim _Result as Integer = Natives.dewarpaModelStatus(dewa.Pointer,   pageno,   pvsuccess,   phsuccess)
