...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixSobelEdgeFilter(pixs.Pointer,   orientflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixTwoSidedEdgeFilter(pixs.Pointer,   orientflag)
...
Public Shared Function pixMeasureEdgeSmoothness(
				...
				<Out()> Optional  ByRef pjpl as Single = 0f, 
				<Out()> Optional  ByRef pjspl as Single = 0f, 
				<Out()> Optional  ByRef prpl as Single = 0f, 
				Optional ByVal debugfile as String = "") as Integer


if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as Integer = Natives.pixMeasureEdgeSmoothness(pixs.Pointer,   side,   minjump,   minreversal,   pjpl,   pjspl,   prpl,   debugfile)
...
Public Shared Function pixGetEdgeProfile(
				ByVal pixs as Pix, 
				ByVal side as Enumerations.L_scan_direction, 
				Optional ByVal debugfile as String = "") as Numa


if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixGetEdgeProfile(pixs.Pointer,   side,   debugfile)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetLastOffPixelInRun(pixs.Pointer,   x,   y,   direction,   ploc)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetLastOnPixelInRun(pixs.Pointer,   x,   y,   direction,   ploc)
