...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixGammaTRC(pixdPtr, pixs.Pointer,   gamma,   minval,   maxval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixGammaTRCMasked(pixdPtr, pixs.Pointer, pixmPtr,   gamma,   minval,   maxval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixGammaTRCWithAlpha(pixdPtr, pixs.Pointer,   gamma,   minval,   maxval)
...
Public Shared Function numaGammaTRC(
	...
	Dim _Result as IntPtr = Natives.numaGammaTRC(  gamma,   minval,   maxval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixContrastTRC(pixdPtr, pixs.Pointer,   factor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixContrastTRCMasked(pixdPtr, pixs.Pointer, pixmPtr,   factor)
...
Public Shared Function numaContrastTRC(
	...
	Dim _Result as IntPtr = Natives.numaContrastTRC(  factor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixEqualizeTRC(pixdPtr, pixs.Pointer,   fract,   factor)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaEqualizeTRC(pix.Pointer,   fract,   factor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixTRCMap(pixs.Pointer, pixmPtr, na.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixUnsharpMasking(pixs.Pointer,   halfwidth,   fract)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixUnsharpMaskingGray(pixs.Pointer,   halfwidth,   fract)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixUnsharpMaskingFast(pixs.Pointer,   halfwidth,   fract,   direction)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixUnsharpMaskingGrayFast(pixs.Pointer,   halfwidth,   fract,   direction)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixUnsharpMaskingGray1D(pixs.Pointer,   halfwidth,   fract,   direction)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixUnsharpMaskingGray2D(pixs.Pointer,   halfwidth,   fract)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as IntPtr = Natives.pixModifyHue(pixdPtr, pixs.Pointer,   fract)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as IntPtr = Natives.pixModifySaturation(pixdPtr, pixs.Pointer,   fract)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as Integer = Natives.pixMeasureSaturation(pixs.Pointer,   factor,   psat)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as IntPtr = Natives.pixModifyBrightness(pixdPtr, pixs.Pointer,   fract)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixMosaicColorShiftRGB(pixs.Pointer,   roff,   goff,   boff,   delta,   nincr)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixColorShiftRGB(pixs.Pointer,   rfract,   gfract,   bfract)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as IntPtr = Natives.pixDarkenGray(pixdPtr, pixs.Pointer,   thresh,   satlimit)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixMultConstantColor(pixs.Pointer,   rfact,   gfact,   bfact)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixMultMatrixColor(pixs.Pointer, kel.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixHalfEdgeByBandpass(pixs.Pointer,   sm1h,   sm1v,   sm2h,   sm2v)
