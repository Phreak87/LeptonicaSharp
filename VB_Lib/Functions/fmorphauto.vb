...
if IsNothing (sela) then Throw New ArgumentNullException  ("sela cannot be Nothing")
	Dim _Result as Integer = Natives.fmorphautogen(sela.Pointer,   fileindex,   filename)
...
if IsNothing (sela) then Throw New ArgumentNullException  ("sela cannot be Nothing")
	Dim _Result as Integer = Natives.fmorphautogen1(sela.Pointer,   fileindex,   filename)
...
if IsNothing (sela) then Throw New ArgumentNullException  ("sela cannot be Nothing")
	...
	Dim _Result as Integer = Natives.fmorphautogen2(sela.Pointer,   fileindex,   filename)
