...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixMorphDwa_1(pixd.Pointer, pixs.Pointer,   operation,   selname)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
		...
		if IsNothing (selname) then Throw New ArgumentNullException  ("selname cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixFMorphopGen_1(pixd.Pointer, pixs.Pointer,   operation,   selname)
...
if IsNothing (datad) then Throw New ArgumentNullException  ("datad cannot be Nothing")
	...
	Dim _Result as Integer = Natives.fmorphopgen_low_1(  datad,   w,   h,   wpld,   datas,   wpls,   index)
