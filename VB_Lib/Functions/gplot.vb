...
Public Shared Function gplotCreate(
				...
				Optional ByVal xlabel as String = "", 
				Optional ByVal ylabel as String = "") as GPlot


if IsNothing (rootname) then Throw New ArgumentNullException  ("rootname cannot be Nothing")
	Dim _Result as IntPtr = Natives.gplotCreate(  rootname,   outformat,   title,   xlabel,   ylabel)
...
Public Shared Sub gplotDestroy(
	...
	Natives.gplotDestroy( pgplotPtr)
	
	if pgplotPtr = IntPtr.Zero then pgplot = Nothing else pgplot = new GPlot(pgplotPtr)
End Sub
...
Public Shared Function gplotAddPlot(
				...
				Optional ByVal plottitle as String = "") as Integer
...
if IsNothing (gplot) then Throw New ArgumentNullException  ("gplot cannot be Nothing")
	...
	Dim _Result as Integer = Natives.gplotAddPlot(gplot.Pointer, naxPtr, nay.Pointer,   plotstyle,   plottitle)
...
if IsNothing (gplot) then Throw New ArgumentNullException  ("gplot cannot be Nothing")
	Dim _Result as Integer = Natives.gplotSetScaling(gplot.Pointer,   scaling)
...
if IsNothing (gplot) then Throw New ArgumentNullException  ("gplot cannot be Nothing")
	Dim _Result as Integer = Natives.gplotMakeOutput(gplot.Pointer)
...
if IsNothing (gplot) then Throw New ArgumentNullException  ("gplot cannot be Nothing")
	Dim _Result as Integer = Natives.gplotGenCommandFile(gplot.Pointer)
...
if IsNothing (gplot) then Throw New ArgumentNullException  ("gplot cannot be Nothing")
	Dim _Result as Integer = Natives.gplotGenDataFiles(gplot.Pointer)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	...
	Dim _Result as Integer = Natives.gplotSimple1(na.Pointer,   outformat,   outroot,   title)
...
if IsNothing (na1) then Throw New ArgumentNullException  ("na1 cannot be Nothing")
		...
		if IsNothing (outroot) then Throw New ArgumentNullException  ("outroot cannot be Nothing")
	Dim _Result as Integer = Natives.gplotSimple2(na1.Pointer, na2.Pointer,   outformat,   outroot,   title)
...
if IsNothing (naa) then Throw New ArgumentNullException  ("naa cannot be Nothing")
		if IsNothing (outroot) then Throw New ArgumentNullException  ("outroot cannot be Nothing")
	Dim _Result as Integer = Natives.gplotSimpleN(naa.Pointer,   outformat,   outroot,   title)
...
if IsNothing (nay) then Throw New ArgumentNullException  ("nay cannot be Nothing")
	...
	Dim _Result as Integer = Natives.gplotSimpleXY1(naxPtr, nay.Pointer,   plotstyle,   outformat,   outroot,   title)
...
if IsNothing (nax) then Throw New ArgumentNullException  ("nax cannot be Nothing")
		...
		if IsNothing (outroot) then Throw New ArgumentNullException  ("outroot cannot be Nothing")
	Dim _Result as Integer = Natives.gplotSimpleXY2(nax.Pointer, nay1.Pointer, nay2.Pointer,   plotstyle,   outformat,   outroot,   title)
...
if IsNothing (naay) then Throw New ArgumentNullException  ("naay cannot be Nothing")
	...
	Dim _Result as Integer = Natives.gplotSimpleXYN(naxPtr, naay.Pointer,   plotstyle,   outformat,   outroot,   title)
...
If My.Computer.Filesystem.FileExists (filename) = false then 
	...
	End If
	Dim _Result as IntPtr = Natives.gplotRead(  filename)
...
if IsNothing (filename) then Throw New ArgumentNullException  ("filename cannot be Nothing")
		if IsNothing (gplot) then Throw New ArgumentNullException  ("gplot cannot be Nothing")
	Dim _Result as Integer = Natives.gplotWrite(  filename, gplot.Pointer)
