...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixDitherToBinary(pixs.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixDitherToBinarySpec(pixs.Pointer,   lowerclip,   upperclip)
...
if IsNothing (lined) then Throw New ArgumentNullException  ("lined cannot be Nothing")
		...
		Dim linedPtr as IntPtr = 	Marshal.AllocHGlobal(lined.Length)
		Marshal.Copy(lined, 0, linedPtr, lined.Length)
		Dim bufs1Ptr as IntPtr = 	Marshal.AllocHGlobal(bufs1.Length)
		Marshal.Copy(bufs1, 0, bufs1Ptr, bufs1.Length)
		Dim bufs2Ptr as IntPtr = 	Marshal.AllocHGlobal(bufs2.Length)
...
If {4,8}.contains (pixs.d) = false then Throw New ArgumentException ("4 or 8 bpp")
	Dim _Result as IntPtr = Natives.pixThresholdToBinary(pixs.Pointer,   thresh)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as IntPtr = Natives.pixVarThresholdToBinary(pixs.Pointer, pixg.Pointer)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	...
	Dim _Result as IntPtr = Natives.pixAdaptThresholdToBinary(pixs.Pointer, pixmPtr,   gamma)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	...
	Dim _Result as IntPtr = Natives.pixAdaptThresholdToBinaryGen(pixs.Pointer, pixmPtr,   gamma,   blackval,   whiteval,   thresh)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixGenerateMaskByValue(pixs.Pointer,   val,   usecmap)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixGenerateMaskByBand(pixs.Pointer,   lower,   upper,   inband,   usecmap)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as IntPtr = Natives.pixDitherTo2bpp(pixs.Pointer,   cmapflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as IntPtr = Natives.pixDitherTo2bppSpec(pixs.Pointer,   lowerclip,   upperclip,   cmapflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as IntPtr = Natives.pixThresholdTo2bpp(pixs.Pointer,   nlevels,   cmapflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixThresholdTo4bpp(pixs.Pointer,   nlevels,   cmapflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixThresholdOn8bpp(pixs.Pointer,   nlevels,   cmapflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixThresholdGrayArb(pixs.Pointer,   edgevals,   outdepth,   use_average,   setblack,   setwhite)
...
Public Shared Function makeGrayQuantIndexTable(
	...
	Dim _Result as Integer() = Natives.makeGrayQuantIndexTable(  nlevels)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	...
	Dim _Result as Integer = Natives.makeGrayQuantTableArb(na.Pointer,   outdepth,   ptabPtr, pcmapPtr)
	
	if IsNothing(ptab) then ptab = nothing else ptab = ptab
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixGenerateMaskByBand32(pixs.Pointer,   refval,   delm,   delp,   fractm,   fractp)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixGenerateMaskByDiscr32(pixs.Pointer,   refval1,   refval2,   distflag)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixGrayQuantFromHisto(pixdPtr, pixs.Pointer, pixmPtr,   minfract,   maxsize)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixGrayQuantFromCmap(pixs.Pointer, cmap.Pointer,   mindepth)
