...
Public Shared Function lheapCreate(
	...
	Dim _Result as IntPtr = Natives.lheapCreate(  nalloc,   direction)
...
Public Shared Sub lheapDestroy(
	...
	Natives.lheapDestroy( plhPtr,   freeflag)
	
	if plhPtr = IntPtr.Zero then plh = Nothing else plh = new L_Heap(plhPtr)
End Sub
...
if IsNothing (lh) then Throw New ArgumentNullException  ("lh cannot be Nothing")
	...
	Dim _Result as Integer = Natives.lheapAdd(lh.Pointer,   itemPtr)
...
if IsNothing (lh) then Throw New ArgumentNullException  ("lh cannot be Nothing")
	Dim _Result as IntPtr = Natives.lheapRemove(lh.Pointer)
...
if IsNothing (lh) then Throw New ArgumentNullException  ("lh cannot be Nothing")
	Dim _Result as Integer = Natives.lheapGetCount(lh.Pointer)
...
if IsNothing (lh) then Throw New ArgumentNullException  ("lh cannot be Nothing")
	Dim _Result as Integer = Natives.lheapSwapUp(lh.Pointer,   index)
...
if IsNothing (lh) then Throw New ArgumentNullException  ("lh cannot be Nothing")
	Dim _Result as Integer = Natives.lheapSwapDown(lh.Pointer)
...
if IsNothing (lh) then Throw New ArgumentNullException  ("lh cannot be Nothing")
	Dim _Result as Integer = Natives.lheapSort(lh.Pointer)
...
if IsNothing (lh) then Throw New ArgumentNullException  ("lh cannot be Nothing")
	Dim _Result as Integer = Natives.lheapSortStrictOrder(lh.Pointer)
...
if IsNothing (fp) then Throw New ArgumentNullException  ("fp cannot be Nothing")
		if IsNothing (lh) then Throw New ArgumentNullException  ("lh cannot be Nothing")
	Dim _Result as Integer = Natives.lheapPrint(fp.Pointer, lh.Pointer)
