...
Public Shared Function jbRankHausInit(
	...
	Dim _Result as IntPtr = Natives.jbRankHausInit(  components,   maxwidth,   maxheight,   size,   rank)
...
Public Shared Function jbCorrelationInit(
	...
	Dim _Result as IntPtr = Natives.jbCorrelationInit(  components,   maxwidth,   maxheight,   thresh,   weightfactor)
...
Public Shared Function jbCorrelationInitWithoutComponents(
	...
	Dim _Result as IntPtr = Natives.jbCorrelationInitWithoutComponents(  components,   maxwidth,   maxheight,   thresh,   weightfactor)
...
if IsNothing (classer) then Throw New ArgumentNullException  ("classer cannot be Nothing")
	...
	Dim _Result as Integer = Natives.jbAddPages(classer.Pointer, safiles.Pointer)
...
if IsNothing (classer) then Throw New ArgumentNullException  ("classer cannot be Nothing")
	...
	Dim _Result as Integer = Natives.jbAddPage(classer.Pointer, pixs.Pointer)
...
if IsNothing (classer) then Throw New ArgumentNullException  ("classer cannot be Nothing")
	...
	Dim _Result as Integer = Natives.jbAddPageComponents(classer.Pointer, pixs.Pointer, boxas.Pointer, pixas.Pointer)
...
if IsNothing (classer) then Throw New ArgumentNullException  ("classer cannot be Nothing")
	...
	Dim _Result as Integer = Natives.jbClassifyRankHaus(classer.Pointer, boxa.Pointer, pixas.Pointer)
...
if IsNothing (pix1) then Throw New ArgumentNullException  ("pix1 cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixHaustest(pix1.Pointer, pix2.Pointer, pix3.Pointer, pix4.Pointer,   delx,   dely,   maxdiffw,   maxdiffh)
...
if IsNothing (pix1) then Throw New ArgumentNullException  ("pix1 cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixRankHaustest(pix1.Pointer, pix2.Pointer, pix3.Pointer, pix4.Pointer,   delx,   dely,   maxdiffw,   maxdiffh,   area1,   area3,   rank,   tab8)
...
if IsNothing (classer) then Throw New ArgumentNullException  ("classer cannot be Nothing")
	...
	Dim _Result as Integer = Natives.jbClassifyCorrelation(classer.Pointer, boxa.Pointer, pixas.Pointer)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as Integer = Natives.jbGetComponents(pixs.Pointer,   components,   maxwidth,   maxheight, pboxadPtr, ppixadPtr)
...
Public Shared Function pixWordMaskByDilation(
				ByVal pixs as Pix, 
				ByVal ppixm as Pix, 
				<Out()> Optional  ByRef psize as Integer = 0, 
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixWordMaskByDilation(pixs.Pointer, ppixmPtr,   psize, pixadbPtr)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixWordBoxesByDilation(pixs.Pointer,   minwidth,   minheight,   maxwidth,   maxheight, pboxaPtr,   psize, pixadbPtr)
...
if IsNothing (pixaa) then Throw New ArgumentNullException  ("pixaa cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.jbAccumulateComposites(pixaa.Pointer, pnaPtr, pptatPtr)
...
if IsNothing (pixac) then Throw New ArgumentNullException  ("pixac cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.jbTemplatesFromComposites(pixac.Pointer, na.Pointer)
...
Public Shared Function jbClasserCreate(
	...
	Dim _Result as IntPtr = Natives.jbClasserCreate(  method,   components)
...
if IsNothing (classer) then Throw New ArgumentNullException  ("classer cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.jbDataSave(classer.Pointer)
...
if IsNothing (rootout) then Throw New ArgumentNullException  ("rootout cannot be Nothing")
	...
	Dim _Result as Integer = Natives.jbDataWrite(  rootout, jbdata.Pointer)
...
if IsNothing (rootname) then Throw New ArgumentNullException  ("rootname cannot be Nothing")
	Dim _Result as IntPtr = Natives.jbDataRead(  rootname)
...
if IsNothing (data) then Throw New ArgumentNullException  ("data cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.jbDataRender(data.Pointer,   debugflag)
...
if IsNothing (classer) then Throw New ArgumentNullException  ("classer cannot be Nothing")
	...
	Dim _Result as Integer = Natives.jbGetULCorners(classer.Pointer, pixs.Pointer, boxa.Pointer)
...
if IsNothing (classer) then Throw New ArgumentNullException  ("classer cannot be Nothing")
	...
	Dim _Result as Integer = Natives.jbGetLLCorners(classer.Pointer)
