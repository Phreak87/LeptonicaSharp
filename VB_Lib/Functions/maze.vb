...
Public Shared Function generateBinaryMaze(
	...
	Dim _Result as IntPtr = Natives.generateBinaryMaze(  w,   h,   xi,   yi,   wallps,   ranis)
...
Public Shared Function pixSearchBinaryMaze(
				...
				ByVal xf as Integer, 
				ByVal yf as Integer, 
				<Out()> Optional  ByRef ppixd as Pix = Nothing) as Pta


if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim ppixdPtr as IntPtr = IntPtr.Zero

	Dim _Result as IntPtr = Natives.pixSearchBinaryMaze(pixs.Pointer,   xi,   yi,   xf,   yf, ppixdPtr)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixSearchGrayMaze(pixs.Pointer,   xi,   yi,   xf,   yf, ppixdPtr)
