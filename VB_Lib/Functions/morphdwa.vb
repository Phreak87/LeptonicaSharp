...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixDilateBrickDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixErodeBrickDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixOpenBrickDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixCloseBrickDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixDilateCompBrickDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixErodeCompBrickDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixOpenCompBrickDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixCloseCompBrickDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixDilateCompBrickExtendDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixErodeCompBrickExtendDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixOpenCompBrickExtendDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixCloseCompBrickExtendDwa(pixdPtr, pixs.Pointer,   hsize,   vsize)
...
Public Shared Function getExtendedCompositeParameters(
				...
				<Out()> Optional  ByRef pactualsize as Integer = 0) as Integer


	Dim _Result as Integer = Natives.getExtendedCompositeParameters(  size,   pn,   pextra,   pactualsize)
