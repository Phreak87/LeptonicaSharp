...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixMorphSequence(pixs.Pointer,   sequence,   dispsep)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (sequence) then Throw New ArgumentNullException  ("sequence cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixMorphCompSequence(pixs.Pointer,   sequence,   dispsep)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (sequence) then Throw New ArgumentNullException  ("sequence cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixMorphSequenceDwa(pixs.Pointer,   sequence,   dispsep)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (sequence) then Throw New ArgumentNullException  ("sequence cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixMorphCompSequenceDwa(pixs.Pointer,   sequence,   dispsep)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as Integer = Natives.morphSequenceVerify(sa.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (sequence) then Throw New ArgumentNullException  ("sequence cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixGrayMorphSequence(pixs.Pointer,   sequence,   dispsep,   dispy)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (sequence) then Throw New ArgumentNullException  ("sequence cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixColorMorphSequence(pixs.Pointer,   sequence,   dispsep,   dispy)
