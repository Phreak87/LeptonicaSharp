...
if IsNothing (na1) then Throw New ArgumentNullException  ("na1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.numaArithOp(nadPtr, na1.Pointer, na2.Pointer,   op)
...
if IsNothing (na1) then Throw New ArgumentNullException  ("na1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.numaLogicalOp(nadPtr, na1.Pointer, na2.Pointer,   op)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.numaInvert(nadPtr, nas.Pointer)
...
if IsNothing (na1) then Throw New ArgumentNullException  ("na1 cannot be Nothing")
		if IsNothing (na2) then Throw New ArgumentNullException  ("na2 cannot be Nothing")
	Dim _Result as Integer = Natives.numaSimilar(na1.Pointer, na2.Pointer,   maxdiff,   psimilar)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaAddToNumber(na.Pointer,   index,   val)
...
Public Shared Function numaGetMin(
				...
				<Out()> Optional  ByRef piminloc as Integer = 0) as Integer


if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetMin(na.Pointer,   pminval,   piminloc)
...
Public Shared Function numaGetMax(
				...
				<Out()> Optional  ByRef pimaxloc as Integer = 0) as Integer


if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetMax(na.Pointer,   pmaxval,   pimaxloc)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetSum(na.Pointer,   psum)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaGetPartialSums(na.Pointer)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetSumOnInterval(na.Pointer,   first,   last,   psum)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaHasOnlyIntegers(na.Pointer,   maxsamples,   pallints)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaSubsample(nas.Pointer,   subfactor)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaMakeDelta(nas.Pointer)
...
Public Shared Function numaMakeSequence(
	...
	Dim _Result as IntPtr = Natives.numaMakeSequence(  startval,   increment,   size)
...
Public Shared Function numaMakeConstant(
	...
	Dim _Result as IntPtr = Natives.numaMakeConstant(  val,   size)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.numaMakeAbsValue(nadPtr, nas.Pointer)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaAddBorder(nas.Pointer,   left,   right,   val)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaAddSpecifiedBorder(nas.Pointer,   left,   right,   type)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaRemoveBorder(nas.Pointer,   left,   right)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaCountNonzeroRuns(na.Pointer,   pcount)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetNonzeroRange(na.Pointer,   eps,   pfirst,   plast)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetCountRelativeToZero(na.Pointer,   type,   pcount)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaClipToInterval(nas.Pointer,   first,   last)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaMakeThresholdIndicator(nas.Pointer,   thresh,   type)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaUniformSampling(nas.Pointer,   nsamp)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.numaReverse(nadPtr, nas.Pointer)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaLowPassIntervals(nas.Pointer,   thresh,   maxn)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaThresholdEdges(nas.Pointer,   thresh1,   thresh2,   maxn)
...
Public Shared Function numaGetSpanValues(
				...
				<Out()> Optional  ByRef pstart as Integer = 0, 
				<Out()> Optional  ByRef pend as Integer = 0) as Integer


if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetSpanValues(na.Pointer,   span,   pstart,   pend)
...
Public Shared Function numaGetEdgeValues(
				...
				<Out()> Optional  ByRef pstart as Integer = 0, 
				<Out()> Optional  ByRef pend as Integer = 0, 
				<Out()> Optional  ByRef psign as Integer = 0) as Integer


if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetEdgeValues(na.Pointer,   edge,   pstart,   pend,   psign)
...
if IsNothing (nay) then Throw New ArgumentNullException  ("nay cannot be Nothing")
	Dim _Result as Integer = Natives.numaInterpolateEqxVal(  startx,   deltax, nay.Pointer,   type,   xval,   pyval)
...
if IsNothing (nax) then Throw New ArgumentNullException  ("nax cannot be Nothing")
		if IsNothing (nay) then Throw New ArgumentNullException  ("nay cannot be Nothing")
	Dim _Result as Integer = Natives.numaInterpolateArbxVal(nax.Pointer, nay.Pointer,   type,   xval,   pyval)
...
if IsNothing (nasy) then Throw New ArgumentNullException  ("nasy cannot be Nothing")
	...
	Dim _Result as Integer = Natives.numaInterpolateEqxInterval(  startx,   deltax, nasy.Pointer,   type,   x0,   x1,   npts, pnaxPtr, pnayPtr)
...
if IsNothing (nax) then Throw New ArgumentNullException  ("nax cannot be Nothing")
		if IsNothing (nay) then Throw New ArgumentNullException  ("nay cannot be Nothing")
	Dim pnadxPtr as IntPtr = IntPtr.Zero
	Dim pnadyPtr as IntPtr = IntPtr.Zero

	Dim _Result as Integer = Natives.numaInterpolateArbxInterval(nax.Pointer, nay.Pointer,   type,   x0,   x1,   npts, pnadxPtr, pnadyPtr)
	
	if pnadxPtr = IntPtr.Zero then pnadx = Nothing else pnadx = new Numa(pnadxPtr)
	if pnadyPtr = IntPtr.Zero then pnady = Nothing else pnady = new Numa(pnadyPtr)
	return _Result
End Function
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	...
	Dim _Result as Integer = Natives.numaFitMax(na.Pointer,   pmaxval, nalocPtr,   pmaxloc)
...
if IsNothing (nax) then Throw New ArgumentNullException  ("nax cannot be Nothing")
	...
	Dim _Result as Integer = Natives.numaDifferentiateInterval(nax.Pointer, nay.Pointer,   x0,   x1,   npts, pnadxPtr, pnadyPtr)
...
if IsNothing (nax) then Throw New ArgumentNullException  ("nax cannot be Nothing")
		if IsNothing (nay) then Throw New ArgumentNullException  ("nay cannot be Nothing")
	Dim _Result as Integer = Natives.numaIntegrateInterval(nax.Pointer, nay.Pointer,   x0,   x1,   npts,   psum)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim pnasortPtr as IntPtr = IntPtr.Zero
	Dim pnaindexPtr as IntPtr = IntPtr.Zero
	Dim pnainvertPtr as IntPtr = IntPtr.Zero

	Dim _Result as Integer = Natives.numaSortGeneral(na.Pointer, pnasortPtr, pnaindexPtr, pnainvertPtr,   sortorder,   sorttype)
	
	if pnasortPtr = IntPtr.Zero then pnasort = Nothing else pnasort = new Numa(pnasortPtr)
	if pnaindexPtr = IntPtr.Zero then pnaindex = Nothing else pnaindex = new Numa(pnaindexPtr)
	if pnainvertPtr = IntPtr.Zero then pnainvert = Nothing else pnainvert = new Numa(pnainvertPtr)
	return _Result
End Function
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaSortAutoSelect(nas.Pointer,   sortorder)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaSortIndexAutoSelect(nas.Pointer,   sortorder)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as Integer = Natives.numaChooseSortType(nas.Pointer)
...
if IsNothing (naout) then Throw New ArgumentNullException  ("naout cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.numaSort(naout.Pointer, nain.Pointer,   sortorder)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaBinSort(nas.Pointer,   sortorder)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaGetSortIndex(na.Pointer,   sortorder)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaGetBinSortIndex(nas.Pointer,   sortorder)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.numaSortByIndex(nas.Pointer, naindex.Pointer)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as Integer = Natives.numaIsSorted(nas.Pointer,   sortorder,   psorted)
...
if IsNothing (nax) then Throw New ArgumentNullException  ("nax cannot be Nothing")
		if IsNothing (nay) then Throw New ArgumentNullException  ("nay cannot be Nothing")
	Dim pnasxPtr as IntPtr = IntPtr.Zero
	Dim pnasyPtr as IntPtr = IntPtr.Zero

	Dim _Result as Integer = Natives.numaSortPair(nax.Pointer, nay.Pointer,   sortorder, pnasxPtr, pnasyPtr)
	
	if pnasxPtr = IntPtr.Zero then pnasx = Nothing else pnasx = new Numa(pnasxPtr)
	if pnasyPtr = IntPtr.Zero then pnasy = Nothing else pnasy = new Numa(pnasyPtr)
	return _Result
End Function
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaInvertMap(nas.Pointer)
...
Public Shared Function numaPseudorandomSequence(
	...
	Dim _Result as IntPtr = Natives.numaPseudorandomSequence(  size,   seed)
...
if IsNothing (nas) then Throw New ArgumentNullException  ("nas cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaRandomPermutation(nas.Pointer,   seed)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	...
	Dim _Result as Integer = Natives.numaGetRankValue(na.Pointer,   fract, nasortPtr,   usebins,   pval)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetMedian(na.Pointer,   pval)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetBinnedMedian(na.Pointer,   pval)
...
Public Shared Function numaGetMode(
				...
				<Out()> Optional  ByRef pcount as Integer = 0) as Integer


if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetMode(na.Pointer,   pval,   pcount)
...
if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.numaGetMedianVariation(na.Pointer,   pmedval,   pmedvar)
...
if IsNothing (nad) then Throw New ArgumentNullException  ("nad cannot be Nothing")
	...
	Dim _Result as Integer = Natives.numaJoin(nad.Pointer, nasPtr,   istart,   iend)
...
if IsNothing (naad) then Throw New ArgumentNullException  ("naad cannot be Nothing")
	...
	Dim _Result as Integer = Natives.numaaJoin(naad.Pointer, naasPtr,   istart,   iend)
...
if IsNothing (naa) then Throw New ArgumentNullException  ("naa cannot be Nothing")
	Dim _Result as IntPtr = Natives.numaaFlattenToNuma(naa.Pointer)
