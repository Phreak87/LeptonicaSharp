...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetSelectCmap(pixs.Pointer, boxPtr,   sindex,   rval,   gval,   bval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixColorGrayRegionsCmap(pixs.Pointer, boxa.Pointer,   type,   rval,   gval,   bval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixColorGrayCmap(pixs.Pointer, boxPtr,   type,   rval,   gval,   bval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixColorGrayMaskedCmap(pixs.Pointer, pixm.Pointer,   type,   rval,   gval,   bval)
...
if IsNothing (cmap) then Throw New ArgumentNullException  ("cmap cannot be Nothing")
	...
	Dim _Result as Integer = Natives.addColorizedGrayToCmap(cmap.Pointer,   type,   rval,   gval,   bval, pnaPtr)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetSelectMaskedCmap(pixs.Pointer, pixmPtr,   x,   y,   sindex,   rval,   gval,   bval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetMaskedCmap(pixs.Pointer, pixmPtr,   x,   y,   rval,   gval,   bval)
