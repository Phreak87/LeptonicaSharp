...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.boxaGetWhiteblocks(boxas.Pointer, box.Pointer,   sortflag,   maxboxes,   maxoverlap,   maxperim,   fract,   maxpops)
...
if IsNothing (boxas) then Throw New ArgumentNullException  ("boxas cannot be Nothing")
	Dim _Result as IntPtr = Natives.boxaPruneSortedOnOverlap(boxas.Pointer,   maxoverlap)
