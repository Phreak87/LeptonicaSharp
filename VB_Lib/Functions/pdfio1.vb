...
if IsNothing (dirname) then Throw New ArgumentNullException  ("dirname cannot be Nothing")
	...
	Dim _Result as Integer = Natives.convertFilesToPdf(  dirname,   substr,   res,   scalefactor,   type,   quality,   title,   fileout)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
		if IsNothing (fileout) then Throw New ArgumentNullException  ("fileout cannot be Nothing")
	Dim _Result as Integer = Natives.saConvertFilesToPdf(sa.Pointer,   res,   scalefactor,   type,   quality,   title,   fileout)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.saConvertFilesToPdfData(sa.Pointer,   res,   scalefactor,   type,   quality,   title,   pdataPtr,   pnbytes)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.selectDefaultPdfEncoding(pix.Pointer,   ptype)
...
if IsNothing (dirname) then Throw New ArgumentNullException  ("dirname cannot be Nothing")
		if IsNothing (fileout) then Throw New ArgumentNullException  ("fileout cannot be Nothing")
	Dim _Result as Integer = Natives.convertUnscaledFilesToPdf(  dirname,   substr,   title,   fileout)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
		if IsNothing (fileout) then Throw New ArgumentNullException  ("fileout cannot be Nothing")
	Dim _Result as Integer = Natives.saConvertUnscaledFilesToPdf(sa.Pointer,   title,   fileout)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.saConvertUnscaledFilesToPdfData(sa.Pointer,   title,   pdataPtr,   pnbytes)
...
if IsNothing (fname) then Throw New ArgumentNullException  ("fname cannot be Nothing")
	...
	Dim _Result as Integer = Natives.convertUnscaledToPdfData(  fname,   title,   pdataPtr,   pnbytes)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
		if IsNothing (fileout) then Throw New ArgumentNullException  ("fileout cannot be Nothing")
	Dim _Result as Integer = Natives.pixaConvertToPdf(pixa.Pointer,   res,   scalefactor,   type,   quality,   title,   fileout)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixaConvertToPdfData(pixa.Pointer,   res,   scalefactor,   type,   quality,   title,   pdataPtr,   pnbytes)
...
if IsNothing (filein) then Throw New ArgumentNullException  ("filein cannot be Nothing")
	...
	Dim _Result as Integer = Natives.convertToPdf(  filein,   type,   quality,   fileout,   x,   y,   res,   title,  plpdPtr,   position)
...
if IsNothing (imdata) then Throw New ArgumentNullException  ("imdata cannot be Nothing")
	...
	Dim _Result as Integer = Natives.convertImageDataToPdf(  imdata,   size,   type,   quality,   fileout,   x,   y,   res,   title,  plpdPtr,   position)
...
if IsNothing (filein) then Throw New ArgumentNullException  ("filein cannot be Nothing")
	...
	Dim _Result as Integer = Natives.convertToPdfData(  filein,   type,   quality,   pdataPtr,   pnbytes,   x,   y,   res,   title,  plpdPtr,   position)
...
if IsNothing (imdata) then Throw New ArgumentNullException  ("imdata cannot be Nothing")
	Dim pdataPtr as IntPtr = IntPtr.Zero
	Dim plpdPtr as IntPtr = IntPtr.Zero

	Dim _Result as Integer = Natives.convertImageDataToPdfData(  imdata,   size,   type,   quality,   pdataPtr,   pnbytes,   x,   y,   res,   title, plpdPtr,   position)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixConvertToPdf(pix.Pointer,   type,   quality,   fileout,   x,   y,   res,   title,  plpdPtr,   position)
...
if IsNothing (fp) then Throw New ArgumentNullException  ("fp cannot be Nothing")
		if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixWriteStreamPdf(fp.Pointer, pix.Pointer,   res,   title)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixWriteMemPdf(  pdataPtr,   pnbytes, pix.Pointer,   res,   title)
...
if IsNothing (dirname) then Throw New ArgumentNullException  ("dirname cannot be Nothing")
	...
	Dim _Result as Integer = Natives.convertSegmentedFilesToPdf(  dirname,   substr,   res,   type,   thresh, baaPtr,   quality,   scalefactor,   title,   fileout)
...
if IsNothing (dirname) then Throw New ArgumentNullException  ("dirname cannot be Nothing")
	Dim _Result as IntPtr = Natives.convertNumberedMasksToBoxaa(  dirname,   substr,   numpre,   numpost)
...
if IsNothing (filein) then Throw New ArgumentNullException  ("filein cannot be Nothing")
	...
	Dim _Result as Integer = Natives.convertToPdfSegmented(  filein,   res,   type,   thresh, boxaPtr,   quality,   scalefactor,   title,   fileout)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixConvertToPdfSegmented(pixs.Pointer,   res,   type,   thresh, boxaPtr,   quality,   scalefactor,   title,   fileout)
...
if IsNothing (filein) then Throw New ArgumentNullException  ("filein cannot be Nothing")
	...
	Dim _Result as Integer = Natives.convertToPdfDataSegmented(  filein,   res,   type,   thresh, boxaPtr,   quality,   scalefactor,   title,   pdataPtr,   pnbytes)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixConvertToPdfDataSegmented(pixs.Pointer,   res,   type,   thresh, boxaPtr,   quality,   scalefactor,   title,   pdataPtr,   pnbytes)
...
if IsNothing (dirname) then Throw New ArgumentNullException  ("dirname cannot be Nothing")
		if IsNothing (fileout) then Throw New ArgumentNullException  ("fileout cannot be Nothing")
	Dim _Result as Integer = Natives.concatenatePdf(  dirname,   substr,   fileout)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
		if IsNothing (fileout) then Throw New ArgumentNullException  ("fileout cannot be Nothing")
	Dim _Result as Integer = Natives.saConcatenatePdf(sa.Pointer,   fileout)
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
		if IsNothing (fileout) then Throw New ArgumentNullException  ("fileout cannot be Nothing")
	Dim _Result as Integer = Natives.ptraConcatenatePdf(pa.Pointer,   fileout)
...
if IsNothing (dirname) then Throw New ArgumentNullException  ("dirname cannot be Nothing")
	...
	Dim _Result as Integer = Natives.concatenatePdfToData(  dirname,   substr,   pdataPtr,   pnbytes)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.saConcatenatePdfToData(sa.Pointer,   pdataPtr,   pnbytes)
