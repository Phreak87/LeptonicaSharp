...
Public Shared Function pixCreate(
	...
	Dim _Result as IntPtr = Natives.pixCreate(  width,   height,   depth)
...
Public Shared Function pixCreateNoInit(
	...
	Dim _Result as IntPtr = Natives.pixCreateNoInit(  width,   height,   depth)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixCreateTemplate(pixs.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixCreateTemplateNoInit(pixs.Pointer)
...
Public Shared Function pixCreateHeader(
	...
	Dim _Result as IntPtr = Natives.pixCreateHeader(  width,   height,   depth)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixClone(pixs.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixCopy(pixdPtr, pixs.Pointer)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
		if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixResizeImageData(pixd.Pointer, pixs.Pointer)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
		if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixCopyColormap(pixd.Pointer, pixs.Pointer)
...
if IsNothing (pix1) then Throw New ArgumentNullException  ("pix1 cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSizesEqual(pix1.Pointer, pix2.Pointer)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixTransferAllData(pixd.Pointer,  ppixsPtr,   copytext,   copyformat)
	
	if ppixsPtr = IntPtr.Zero then ppixs = Nothing else ppixs = new Pix(ppixsPtr)
	return _Result
End Function
...
Public Shared Function pixSwapAndDestroy(
	...
	Dim _Result as Integer = Natives.pixSwapAndDestroy(ppixdPtr,  ppixsPtr)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetWidth(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetWidth(pix.Pointer,   width)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetHeight(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetHeight(pix.Pointer,   height)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetDepth(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetDepth(pix.Pointer,   depth)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixGetDimensions(pix.Pointer,   pw,   ph,   pd)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetDimensions(pix.Pointer,   w,   h,   d)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
		if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixCopyDimensions(pixd.Pointer, pixs.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetSpp(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetSpp(pix.Pointer,   spp)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
		if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixCopySpp(pixd.Pointer, pixs.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetWpl(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetWpl(pix.Pointer,   wpl)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetRefcount(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixChangeRefcount(pix.Pointer,   delta)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetXRes(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetXRes(pix.Pointer,   res)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetYRes(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetYRes(pix.Pointer,   res)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixGetResolution(pix.Pointer,   pxres,   pyres)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetResolution(pix.Pointer,   xres,   yres)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixCopyResolution(pixd.Pointer, pixs.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixScaleResolution(pix.Pointer,   xscale,   yscale)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetInputFormat(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetInputFormat(pix.Pointer,   informat)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixCopyInputFormat(pixd.Pointer, pixs.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetSpecial(pix.Pointer,   special)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as String = Natives.pixGetText(pix.Pointer)
...
Public Shared Function pixSetText(
				ByVal pix as Pix, 
				Optional ByVal textstring as String = "") as Integer


if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetText(pix.Pointer,   textstring)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixAddText(pix.Pointer,   textstring)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixCopyText(pixd.Pointer, pixs.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixGetColormap(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetColormap(pix.Pointer, colormap.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixDestroyColormap(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixGetData(pix.Pointer)
	
	Dim B(pix.w * pix.h * (pix.d/8)) As Byte
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetData(pix.Pointer,   dataPtr)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixExtractData(pixs.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixFreeData(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixGetLinePtrs(pix.Pointer,   psize)
	
	Dim B(psize) As IntPtr
	Marshal.Copy(_Result, B, 0, B.Length)
	return B
End Function
...
if IsNothing (fp) then Throw New ArgumentNullException  ("fp cannot be Nothing")
		if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixPrintStreamInfo(fp.Pointer, pix.Pointer,   text)
