...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixGetPixel(pix.Pointer,   x,   y,   pval)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetPixel(pix.Pointer,   x,   y,   val)
...
Public Shared Function pixGetRGBPixel(
				...
				<Out()> Optional  ByRef pbval as Integer = 0) as Integer


if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
If {32}.contains (pix.d) = false then Throw New ArgumentException ("32 bpp rgb, not colormapped")
	Dim _Result as Integer = Natives.pixGetRGBPixel(pix.Pointer,   x,   y,   prval,   pgval,   pbval)
...
If {32}.contains (pix.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as Integer = Natives.pixSetRGBPixel(pix.Pointer,   x,   y,   rval,   gval,   bval)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixGetRandomPixel(pix.Pointer,   pval,   px,   py)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixClearPixel(pix.Pointer,   x,   y)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixFlipPixel(pix.Pointer,   x,   y)
...
if IsNothing (line) then Throw New ArgumentNullException  ("line cannot be Nothing")
		Dim linePtr as IntPtr = 	Marshal.AllocHGlobal(line.Length)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixGetBlackOrWhiteVal(pixs.Pointer,   op,   pval)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixClearAll(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetAll(pix.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetAllGray(pix.Pointer,   grayval)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetAllArbitrary(pix.Pointer,   val)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetBlackOrWhite(pixs.Pointer,   op)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetComponentArbitrary(pix.Pointer,   comp,   val)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixClearInRect(pix.Pointer, box.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
		if IsNothing (box) then Throw New ArgumentNullException  ("box cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetInRect(pix.Pointer, box.Pointer)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
		if IsNothing (box) then Throw New ArgumentNullException  ("box cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetInRectArbitrary(pix.Pointer, box.Pointer,   val)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as Integer = Natives.pixBlendInRect(pixs.Pointer, boxPtr,   val,   fract)
...
If {1,2,4,8,16,32}.contains (pix.d) = false then Throw New ArgumentException ("1, 2, 4, 8, 16, 32 bpp")
	Dim _Result as Integer = Natives.pixSetPadBits(pix.Pointer,   val)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
If {1,2,4,8,16,32}.contains (pix.d) = false then Throw New ArgumentException ("1, 2, 4, 8, 16, 32 bpp")
	Dim _Result as Integer = Natives.pixSetPadBitsBand(pix.Pointer,   by,   bh,   val)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetOrClearBorder(pixs.Pointer,   left,   right,   top,   bot,   op)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetBorderVal(pixs.Pointer,   left,   right,   top,   bot,   val)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetBorderRingVal(pixs.Pointer,   dist,   val)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixSetMirroredBorder(pixs.Pointer,   left,   right,   top,   bot)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
		if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixCopyBorder(pixd.Pointer, pixs.Pointer,   left,   right,   top,   bot)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAddBorder(pixs.Pointer,   npix,   val)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAddBlackOrWhiteBorder(pixs.Pointer,   left,   right,   top,   bot,   op)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAddBorderGeneral(pixs.Pointer,   left,   right,   top,   bot,   val)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixRemoveBorder(pixs.Pointer,   npix)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixRemoveBorderGeneral(pixs.Pointer,   left,   right,   top,   bot)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixRemoveBorderToSize(pixs.Pointer,   wd,   hd)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAddMirroredBorder(pixs.Pointer,   left,   right,   top,   bot)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAddRepeatedBorder(pixs.Pointer,   left,   right,   top,   bot)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAddMixedBorder(pixs.Pointer,   left,   right,   top,   bot)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAddContinuedBorder(pixs.Pointer,   left,   right,   top,   bot)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
		if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixShiftAndTransferAlpha(pixd.Pointer, pixs.Pointer,   shiftx,   shifty)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixDisplayLayersRGBA(pixs.Pointer,   val,   maxw)
...
if IsNothing (pixr) then Throw New ArgumentNullException  ("pixr cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixCreateRGBImage(pixr.Pointer, pixg.Pointer, pixb.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixGetRGBComponent(pixs.Pointer,   comp)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as Integer = Natives.pixSetRGBComponent(pixd.Pointer, pixs.Pointer,   comp)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixGetRGBComponentCmap(pixs.Pointer,   comp)
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
		if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixCopyRGBComponent(pixd.Pointer, pixs.Pointer,   comp)
...
Public Shared Function composeRGBPixel(
	...
	Dim _Result as Integer = Natives.composeRGBPixel(  rval,   gval,   bval,   ppixel)
...
Public Shared Function composeRGBAPixel(
	...
	Dim _Result as Integer = Natives.composeRGBAPixel(  rval,   gval,   bval,   aval,   ppixel)
...
Public Shared Sub extractRGBValues(
	...
	Natives.extractRGBValues(  pixel,   prval,   pgval,   pbval)
...
Public Shared Sub extractRGBAValues(
				...
				<Out()> Optional  ByRef pgval as Integer = 0, 
				<Out()> Optional  ByRef pbval as Integer = 0, 
				<Out()> Optional  ByRef paval as Integer = 0)


	Natives.extractRGBAValues(  pixel,   prval,   pgval,   pbval,   paval)
...
Public Shared Function extractMinMaxComponent(
	...
	Dim _Result as Integer = Natives.extractMinMaxComponent(  pixel,   type)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixGetRGBLine(pixs.Pointer,   row,   bufr,   bufg,   bufb)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixEndianByteSwapNew(pixs.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixEndianByteSwap(pixs.Pointer)
...
if IsNothing (datad) then Throw New ArgumentNullException  ("datad cannot be Nothing")
	...
	Dim _Result as Integer = Natives.lineEndianByteSwap(  datadPtr,   datasPtr,   wpl)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixEndianTwoByteSwapNew(pixs.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixEndianTwoByteSwap(pixs.Pointer)
...
If {1,8,32}.contains (pixs.d) = false then Throw New ArgumentException ("1, 8, 32 bpp")
	...
	Dim _Result as Integer = Natives.pixGetRasterData(pixs.Pointer,   pdataPtr,   pnbytes)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixAlphaIsOpaque(pix.Pointer,   popaque)
...
Public Shared Function pixSetupByteProcessing(
				...
				<Out()> Optional  ByRef ph as Integer = 0) as List(of Byte())


if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixSetupByteProcessing(pix.Pointer,   pw,   ph)
	
	Dim B As New List(Of Byte())
	Dim PTRs(1) As IntPtr : Marshal.Copy(_Result, PTRs, 0, PTRs.Length)
	For Each PTR In PTRs
	   Dim X(3) As Byte : Marshal.Copy(PTR, X, 0, X.Length) 
	Next
	return B
End Function
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixCleanupByteProcessing(pix.Pointer,   lineptrsPtr)
