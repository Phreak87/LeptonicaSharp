...
' pix3.c (155, 1)
' pixSetMasked(pixd, pixm, val) as Integer
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetMasked(pixd.Pointer, pixmPtr,   val)
	
	return _Result
End Function

' pix3.c (294, 1)
' pixSetMaskedGeneral(pixd, pixm, val, x, y) as Integer
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixSetMaskedGeneral(pixd.Pointer, pixmPtr,   val,   x,   y)
	
	return _Result
End Function

' pix3.c (374, 1)
' pixCombineMasked(pixd, pixs, pixm) as Integer
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixCombineMasked(pixd.Pointer, pixs.Pointer, pixmPtr)
	
	return _Result
End Function

' pix3.c (493, 1)
' pixCombineMaskedGeneral(pixd, pixs, pixm, x, y) as Integer
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixCombineMaskedGeneral(pixd.Pointer, pixs.Pointer, pixmPtr,   x,   y)
	
	return _Result
End Function

' pix3.c (618, 1)
' pixPaintThroughMask(pixd, pixm, x, y, val) as Integer
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixPaintThroughMask(pixd.Pointer, pixmPtr,   x,   y,   val)
	
	return _Result
End Function

' pix3.c (786, 1)
' pixPaintSelfThroughMask(pixd, pixm, x, y, searchdir, mindist, tilesize, ntiles, distblend) as Integer
...
if IsNothing (pixd) then Throw New ArgumentNullException  ("pixd cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixPaintSelfThroughMask(pixd.Pointer, pixm.Pointer,   x,   y,   searchdir,   mindist,   tilesize,   ntiles,   distblend)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixMakeMaskFromVal(pixs.Pointer,   val)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixMakeMaskFromLUT(pixs.Pointer,   tab)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp RGB")
	Dim _Result as IntPtr = Natives.pixMakeArbMaskFromRGB(pixs.Pointer,   rc,   gc,   bc,   thresh)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixSetUnderTransparency(pixs.Pointer,   val,   debug)
...
Public Shared Function pixMakeAlphaFromMask(
				...
				<Out()> Optional  ByRef pbox as Box = Nothing) as Pix
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixMakeAlphaFromMask(pixs.Pointer,   dist, pboxPtr)
...
' pix3.c (1291, 1)
' pixGetColorNearMaskBoundary(pixs, pixm, box, dist, pval, debug) as Integer
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as Integer = Natives.pixGetColorNearMaskBoundary(pixs.Pointer, pixm.Pointer, box.Pointer,   dist,   pval,   debug)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixInvert(pixdPtr, pixs.Pointer)
...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixOr(pixdPtr, pixs1.Pointer, pixs2.Pointer)
...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixAnd(pixdPtr, pixs1.Pointer, pixs2.Pointer)
...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixXor(pixdPtr, pixs1.Pointer, pixs2.Pointer)
...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixSubtract(pixdPtr, pixs1.Pointer, pixs2.Pointer)
...
Public Shared Function pixZero(
				ByVal pix as Pix, 
				<Out()>  ByRef pempty as Integer) as Integer


if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixZero(pix.Pointer,   pempty)
	
	return _Result
End Function

' pix3.c (1751, 1)
' pixForegroundFraction(pix, pfract) as Integer
...
If {1}.contains (pix.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as Integer = Natives.pixForegroundFraction(pix.Pointer,   pfract)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaCountPixels(pixa.Pointer)
...
' pix3.c (1823, 1)
' pixCountPixels(pixs, pcount, tab8) as Integer
...
Public Shared Function pixCountPixels(
				ByVal pixs as Pix, 
				<Out()>  ByRef pcount as Integer, 
				Optional ByVal tab8 as Integer() = nothing) as Integer


if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as Integer = Natives.pixCountPixels(pixs.Pointer,   pcount,   tab8)
	
	return _Result
End Function

' pix3.c (1887, 1)
' pixCountPixelsInRect(pixs, box, pcount, tab8) as Integer
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (box) then Throw New ArgumentNullException  ("box cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as Integer = Natives.pixCountPixelsInRect(pixs.Pointer, box.Pointer,   pcount,   tab8)
...
If {1}.contains (pix.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixCountByRow(pix.Pointer, boxPtr)
...
If {1}.contains (pix.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as IntPtr = Natives.pixCountByColumn(pix.Pointer, boxPtr)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
If {1}.contains (pix.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixCountPixelsByRow(pix.Pointer,   tab8)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
If {1}.contains (pix.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixCountPixelsByColumn(pix.Pointer)
...
' pix3.c (2104, 1)
' pixCountPixelsInRow(pix, row, pcount, tab8) as Integer
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
If {1}.contains (pix.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as Integer = Natives.pixCountPixelsInRow(pix.Pointer,   row,   pcount,   tab8)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
If {1}.contains (pix.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixGetMomentByColumn(pix.Pointer,   order)
...
' pix3.c (2225, 1)
' pixThresholdPixelSum(pix, thresh, pabove, tab8) as Integer
...
Public Shared Function pixThresholdPixelSum(
				...
				<Out()>  ByRef pabove as Integer, 
				Optional ByVal tab8 as Integer() = nothing) as Integer


if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
If {1}.contains (pix.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as Integer = Natives.pixThresholdPixelSum(pix.Pointer,   thresh,   pabove,   tab8)
	
	return _Result
End Function

' pix3.c (2297, 1)
' makePixelSumTab8() as Integer()
...
Public Shared Function makePixelSumTab8() as Integer()
	...
	Dim _Result as Integer() = Natives.makePixelSumTab8()
	
	return _Result
End Function

' pix3.c (2342, 1)
' makePixelCentroidTab8() as Integer()
...
Public Shared Function makePixelCentroidTab8() as Integer()
	...
	Dim _Result as Integer() = Natives.makePixelCentroidTab8()
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixAverageByRow(pix.Pointer, boxPtr,   type)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixAverageByColumn(pix.Pointer, boxPtr,   type)
...
' pix3.c (2534, 1)
' pixAverageInRect(pix, box, pave) as Integer
...
Public Shared Function pixAverageInRect(
				ByVal pix as Pix, 
				ByVal box as Box, 
				<Out()>  ByRef pave as Single) as Integer


if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim boxPtr as IntPtr = IntPtr.Zero : 	If Not IsNothing(box) Then boxPtr = box.Pointer

	Dim _Result as Integer = Natives.pixAverageInRect(pix.Pointer, boxPtr,   pave)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixVarianceByRow(pix.Pointer, boxPtr)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixVarianceByColumn(pix.Pointer, boxPtr)
...
' pix3.c (2723, 1)
' pixVarianceInRect(pix, box, prootvar) as Integer
...
Public Shared Function pixVarianceInRect(
				ByVal pix as Pix, 
				ByVal box as Box, 
				<Out()>  ByRef prootvar as Single) as Integer


if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim boxPtr as IntPtr = IntPtr.Zero : 	If Not IsNothing(box) Then boxPtr = box.Pointer

	Dim _Result as Integer = Natives.pixVarianceInRect(pix.Pointer, boxPtr,   prootvar)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixAbsDiffByRow(pix.Pointer, boxPtr)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixAbsDiffByColumn(pix.Pointer, boxPtr)
...
' pix3.c (2924, 1)
' pixAbsDiffInRect(pix, box, dir, pabsdiff) as Integer
...
Public Shared Function pixAbsDiffInRect(
				...
				<Out()>  ByRef pabsdiff as Single) as Integer


if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim boxPtr as IntPtr = IntPtr.Zero : 	If Not IsNothing(box) Then boxPtr = box.Pointer

	Dim _Result as Integer = Natives.pixAbsDiffInRect(pix.Pointer, boxPtr,   dir,   pabsdiff)
	
	return _Result
End Function

' pix3.c (3001, 1)
' pixAbsDiffOnLine(pix, x1, y1, x2, y2, pabsdiff) as Integer
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as Integer = Natives.pixAbsDiffOnLine(pix.Pointer,   x1,   y1,   x2,   y2,   pabsdiff)
	
	return _Result
End Function

' pix3.c (3083, 1)
' pixCountArbInRect(pixs, box, val, factor, pcount) as Integer
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixCountArbInRect(pixs.Pointer, boxPtr,   val,   factor,   pcount)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixMirroredTiling(pixs.Pointer,   w,   h)
...
' pix3.c (3236, 1)
' pixFindRepCloseTile(pixs, box, searchdir, mindist, tsize, ntiles, pboxtile, debug) as Integer
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (box) then Throw New ArgumentNullException  ("box cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim pboxtilePtr as IntPtr = IntPtr.Zero

	Dim _Result as Integer = Natives.pixFindRepCloseTile(pixs.Pointer, box.Pointer,   searchdir,   mindist,   tsize,   ntiles, pboxtilePtr,   debug)
	
	if pboxtilePtr = IntPtr.Zero then pboxtile = Nothing else pboxtile = new Box(pboxtilePtr)
	return _Result
End Function
