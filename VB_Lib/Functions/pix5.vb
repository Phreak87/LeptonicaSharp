...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixaFindDimensions(pixa.Pointer, pnawPtr, pnahPtr)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as Integer = Natives.pixFindAreaPerimRatio(pixs.Pointer,   tab,   pfract)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaFindPerimToAreaRatio(pixa.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as Integer = Natives.pixFindPerimToAreaRatio(pixs.Pointer,   tab,   pfract)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaFindPerimSizeRatio(pixa.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as Integer = Natives.pixFindPerimSizeRatio(pixs.Pointer,   tab,   pratio)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaFindAreaFraction(pixa.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as Integer = Natives.pixFindAreaFraction(pixs.Pointer,   tab,   pfract)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaFindAreaFractionMasked(pixa.Pointer, pixm.Pointer,   debug)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixFindAreaFractionMasked(pixs.Pointer, boxPtr, pixm.Pointer,   tab,   pfract)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaFindWidthHeightRatio(pixa.Pointer)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaFindWidthHeightProduct(pixa.Pointer)
...
Public Shared Function pixFindOverlapFraction(
				...
				<Out()> Optional  ByRef pnoverlap as Integer = 0) as Integer
...
If {1}.contains (pixs1.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as Integer = Natives.pixFindOverlapFraction(pixs1.Pointer, pixs2.Pointer,   x2,   y2,   tab,   pratio,   pnoverlap)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixFindRectangleComps(pixs.Pointer,   dist,   minw,   minh)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as Integer = Natives.pixConformsToRectangle(pixs.Pointer, boxPtr,   dist,   pconforms)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixClipRectangles(pixs.Pointer, boxa.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim pboxcPtr as IntPtr = IntPtr.Zero

	Dim _Result as IntPtr = Natives.pixClipRectangle(pixs.Pointer, box.Pointer, pboxcPtr)
	
	if pboxcPtr = IntPtr.Zero then pboxc = Nothing else pboxc = new Box(pboxcPtr)
	If _Result = IntPtr.Zero then Return Nothing
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (pixm) then Throw New ArgumentNullException  ("pixm cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixClipMasked(pixs.Pointer, pixm.Pointer,   x,   y,   outval)
...
if IsNothing (pixs1) then Throw New ArgumentNullException  ("pixs1 cannot be Nothing")
		if IsNothing (pixs2) then Throw New ArgumentNullException  ("pixs2 cannot be Nothing")
	Dim ppixd1Ptr as IntPtr = IntPtr.Zero
	Dim ppixd2Ptr as IntPtr = IntPtr.Zero

	Dim _Result as Integer = Natives.pixCropToMatch(pixs1.Pointer, pixs2.Pointer, ppixd1Ptr, ppixd2Ptr)
	
	if ppixd1Ptr = IntPtr.Zero then ppixd1 = Nothing else ppixd1 = new Pix(ppixd1Ptr)
	if ppixd2Ptr = IntPtr.Zero then ppixd2 = Nothing else ppixd2 = new Pix(ppixd2Ptr)
	return _Result
End Function
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixCropToSize(pixs.Pointer,   w,   h)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixResizeToMatch(pixs.Pointer, pixtPtr,   w,   h)
...
Public Shared Function pixMakeFrameMask(
	...
	Dim _Result as IntPtr = Natives.pixMakeFrameMask(  w,   h,   hf1,   hf2,   vf1,   vf2)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixMakeCoveringOfRectangles(pixs.Pointer,   maxiters)
...
If {1}.contains (pix1.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as Integer = Natives.pixFractionFgInMask(pix1.Pointer, pix2.Pointer,   pfract)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as Integer = Natives.pixClipToForeground(pixs.Pointer, ppixdPtr, pboxPtr)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as Integer = Natives.pixTestClipToForeground(pixs.Pointer,   pcanclip)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim ppixdPtr as IntPtr = IntPtr.Zero
	Dim pboxdPtr as IntPtr = IntPtr.Zero

	Dim _Result as Integer = Natives.pixClipBoxToForeground(pixs.Pointer, boxsPtr, ppixdPtr, pboxdPtr)
	
	if ppixdPtr = IntPtr.Zero then ppixd = Nothing else ppixd = new Pix(ppixdPtr)
	if pboxdPtr = IntPtr.Zero then pboxd = Nothing else pboxd = new Box(pboxdPtr)
	return _Result
End Function
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as Integer = Natives.pixScanForForeground(pixs.Pointer, boxPtr,   scanflag,   ploc)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as Integer = Natives.pixClipBoxToEdges(pixs.Pointer, boxsPtr,   lowthresh,   highthresh,   maxwidth,   factor, ppixdPtr, pboxdPtr)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	...
	Dim _Result as Integer = Natives.pixScanForEdge(pixs.Pointer, boxPtr,   lowthresh,   highthresh,   maxwidth,   factor,   scanflag,   ploc)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixExtractOnLine(pixs.Pointer,   x1,   y1,   x2,   y2,   factor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Single = Natives.pixAverageOnLine(pixs.Pointer,   x1,   y1,   x2,   y2,   factor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixAverageIntensityProfile(pixs.Pointer,   fract,   dir,   first,   last,   factor1,   factor2)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixReversalProfile(pixs.Pointer,   fract,   dir,   first,   last,   minreversal,   factor1,   factor2)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixWindowedVarianceOnLine(pixs.Pointer,   dir,   loc,   c1,   c2,   size, pnadPtr)
...
Public Shared Function pixMinMaxNearLine(
				...
				<Out()> Optional  ByRef pminave as Single = 0f, 
				<Out()> Optional  ByRef pmaxave as Single = 0f) as Integer


if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim pnaminPtr as IntPtr = IntPtr.Zero
	Dim pnamaxPtr as IntPtr = IntPtr.Zero

	Dim _Result as Integer = Natives.pixMinMaxNearLine(pixs.Pointer,   x1,   y1,   x2,   y2,   dist,   direction, pnaminPtr, pnamaxPtr,   pminave,   pmaxave)
	
	if pnaminPtr = IntPtr.Zero then pnamin = Nothing else pnamin = new Numa(pnaminPtr)
	if pnamaxPtr = IntPtr.Zero then pnamax = Nothing else pnamax = new Numa(pnamaxPtr)
	return _Result
End Function
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixRankRowTransform(pixs.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixRankColumnTransform(pixs.Pointer)
