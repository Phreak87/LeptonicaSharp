...
Public Shared Function pixSelectBySize(
				...
				<Out()> Optional  ByRef pchanged as Integer = 0) as Pix


if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixSelectBySize(pixs.Pointer,   width,   height,   connectivity,   type,   relation,   pchanged)
...
Public Shared Function pixaSelectBySize(
				...
				ByVal type as Enumerations.L_SELECT, 
				ByVal relation as Enumerations.L_SELECT_IF, 
				<Out()> Optional  ByRef pchanged as Integer = 0) as Pixa


if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaSelectBySize(pixas.Pointer,   width,   height,   type,   relation,   pchanged)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaMakeSizeIndicator(pixa.Pointer,   width,   height,   type,   relation)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixSelectByPerimToAreaRatio(pixs.Pointer,   thresh,   connectivity,   type,   pchanged)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaSelectByPerimToAreaRatio(pixas.Pointer,   thresh,   type,   pchanged)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixSelectByPerimSizeRatio(pixs.Pointer,   thresh,   connectivity,   type,   pchanged)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaSelectByPerimSizeRatio(pixas.Pointer,   thresh,   type,   pchanged)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixSelectByAreaFraction(pixs.Pointer,   thresh,   connectivity,   type,   pchanged)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaSelectByAreaFraction(pixas.Pointer,   thresh,   type,   pchanged)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixSelectByWidthHeightRatio(pixs.Pointer,   thresh,   connectivity,   type,   pchanged)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaSelectByWidthHeightRatio(pixas.Pointer,   thresh,   type,   pchanged)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaSelectByNumConnComp(pixas.Pointer,   nmin,   nmax,   connectivity,   pchanged)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaSelectWithIndicator(pixas.Pointer, na.Pointer,   pchanged)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
		if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.pixRemoveWithIndicator(pixs.Pointer, pixa.Pointer, na.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
		if IsNothing (na) then Throw New ArgumentNullException  ("na cannot be Nothing")
	Dim _Result as Integer = Natives.pixAddWithIndicator(pixs.Pointer, pixa.Pointer, na.Pointer)
...
Public Shared Function pixaSelectWithString(
				ByVal pixas as Pixa, 
				ByVal str as String, 
				<Out()> Optional  ByRef perror as Integer = 0) as Pixa


if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
		if IsNothing (str) then Throw New ArgumentNullException  ("str cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaSelectWithString(pixas.Pointer,   str,   perror)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaRenderComponent(pixsPtr, pixa.Pointer,   index)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaSort(pixas.Pointer,   sorttype,   sortorder, pnaindexPtr,   copyflag)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaBinSort(pixas.Pointer,   sorttype,   sortorder, pnaindexPtr,   copyflag)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaSortByIndex(pixas.Pointer, naindex.Pointer,   copyflag)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaSort2dByIndex(pixas.Pointer, naa.Pointer,   copyflag)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaSelectRange(pixas.Pointer,   first,   last,   copyflag)
...
if IsNothing (paas) then Throw New ArgumentNullException  ("paas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaaSelectRange(paas.Pointer,   first,   last,   copyflag)
...
if IsNothing (paas) then Throw New ArgumentNullException  ("paas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaaScaleToSize(paas.Pointer,   wd,   hd)
...
if IsNothing (paas) then Throw New ArgumentNullException  ("paas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaaScaleToSizeVar(paas.Pointer, nawdPtr, nahdPtr)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaScaleToSize(pixas.Pointer,   wd,   hd)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaScaleToSizeRel(pixas.Pointer,   delw,   delh)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaScale(pixas.Pointer,   scalex,   scaley)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaScaleBySampling(pixas.Pointer,   scalex,   scaley)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaRotate(pixas.Pointer,   angle,   type,   incolor,   width,   height)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaRotateOrth(pixas.Pointer,   rotation)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaTranslate(pixas.Pointer,   hshift,   vshift,   incolor)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaAddBorderGeneral(pixadPtr, pixas.Pointer,   left,   right,   top,   bot,   val)
...
if IsNothing (paa) then Throw New ArgumentNullException  ("paa cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaaFlattenToPixa(paa.Pointer, pnaindexPtr,   copyflag)
...
Public Shared Function pixaaSizeRange(
				ByVal paa as Pixaa, 
				<Out()> Optional  ByRef pminw as Integer = 0, 
				<Out()> Optional  ByRef pminh as Integer = 0, 
				<Out()> Optional  ByRef pmaxw as Integer = 0, 
				<Out()> Optional  ByRef pmaxh as Integer = 0) as Integer


if IsNothing (paa) then Throw New ArgumentNullException  ("paa cannot be Nothing")
	Dim _Result as Integer = Natives.pixaaSizeRange(paa.Pointer,   pminw,   pminh,   pmaxw,   pmaxh)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as Integer = Natives.pixaSizeRange(pixa.Pointer,   pminw,   pminh,   pmaxw,   pmaxh)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
		if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaClipToPix(pixas.Pointer, pixs.Pointer)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim ppixadPtr as IntPtr = IntPtr.Zero
	Dim pboxaPtr as IntPtr = IntPtr.Zero

	Dim _Result as Integer = Natives.pixaClipToForeground(pixas.Pointer, ppixadPtr, pboxaPtr)
	
	if ppixadPtr = IntPtr.Zero then ppixad = Nothing else ppixad = new Pixa(ppixadPtr)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as Integer = Natives.pixaGetRenderingDepth(pixa.Pointer,   pdepth)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as Integer = Natives.pixaHasColor(pixa.Pointer,   phascolor)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as Integer = Natives.pixaAnyColormaps(pixa.Pointer,   phascmap)
...
Public Shared Function pixaGetDepthInfo(
				ByVal pixa as Pixa, 
				<Out()> Optional  ByRef pmaxdepth as Integer = 0, 
				<Out()> Optional  ByRef psame as Integer = 0) as Integer


if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as Integer = Natives.pixaGetDepthInfo(pixa.Pointer,   pmaxdepth,   psame)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaConvertToSameDepth(pixas.Pointer)
...
if IsNothing (pixa1) then Throw New ArgumentNullException  ("pixa1 cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixaEqual(pixa1.Pointer, pixa2.Pointer,   maxdist, pnaindexPtr,   psame)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as Integer = Natives.pixaSetFullSizeBoxa(pixa.Pointer)
