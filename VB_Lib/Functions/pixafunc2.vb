...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaDisplay(pixa.Pointer,   w,   h)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaDisplayOnColor(pixa.Pointer,   w,   h,   bgcolor)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaDisplayRandomCmap(pixa.Pointer,   w,   h)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaDisplayLinearly(pixas.Pointer,   direction,   scalefactor,   background,   spacing,   border, pboxaPtr)
...
Public Shared Function pixaDisplayOnLattice(
				...
				<Out()> Optional  ByRef pncols as Integer = 0, 
				<Out()> Optional  ByRef pboxa as Boxa = Nothing) as Pix
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaDisplayOnLattice(pixa.Pointer,   cellw,   cellh,   pncols, pboxaPtr)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaDisplayUnsplit(pixa.Pointer,   nx,   ny,   borderwidth,   bordercolor)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaDisplayTiled(pixa.Pointer,   maxwidth,   background,   spacing)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaDisplayTiledInRows(pixa.Pointer,   outdepth,   maxwidth,   scalefactor,   background,   spacing,   border)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaDisplayTiledInColumns(pixas.Pointer,   nx,   scalefactor,   spacing,   border)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaDisplayTiledAndScaled(pixa.Pointer,   outdepth,   tilewidth,   ncols,   background,   spacing,   border)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaDisplayTiledWithText(pixa.Pointer,   maxwidth,   scalefactor,   spacing,   border,   fontsize,   textcolor)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaDisplayTiledByIndex(pixa.Pointer, na.Pointer,   width,   spacing,   border,   fontsize,   textcolor)
...
if IsNothing (paa) then Throw New ArgumentNullException  ("paa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaaDisplay(paa.Pointer,   w,   h)
...
if IsNothing (paa) then Throw New ArgumentNullException  ("paa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaaDisplayByPixa(paa.Pointer,   xspace,   yspace,   maxw)
...
if IsNothing (paa) then Throw New ArgumentNullException  ("paa cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaaDisplayTiledAndScaled(paa.Pointer,   outdepth,   tilewidth,   ncols,   background,   spacing,   border)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaConvertTo1(pixas.Pointer,   thresh)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaConvertTo8(pixas.Pointer,   cmapflag)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaConvertTo8Colormap(pixas.Pointer,   dither)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaConvertTo32(pixas.Pointer)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaConstrainedSelect(pixas.Pointer,   first,   last,   nmax,   use_pairs,   copyflag)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	...
	Dim _Result as Integer = Natives.pixaSelectToPdf(pixas.Pointer,   first,   last,   res,   scalefactor,   type,   quality,   color,   fontsize,   fileout)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixaDisplayMultiTiled(pixas.Pointer,   nx,   ny,   maxw,   maxh,   scalefactor,   spacing,   border)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	Dim _Result as Integer = Natives.pixaSplitIntoFiles(pixas.Pointer,   nsplit,   scale,   outwidth,   write_pixa,   write_pix,   write_pdf)
...
if IsNothing (dir) then Throw New ArgumentNullException  ("dir cannot be Nothing")
	...
	Dim _Result as Integer = Natives.convertToNUpFiles(  dir,   substr,   nx,   ny,   tw,   spacing,   border,   fontsize,   outdir)
...
if IsNothing (dir) then Throw New ArgumentNullException  ("dir cannot be Nothing")
	Dim _Result as IntPtr = Natives.convertToNUpPixa(  dir,   substr,   nx,   ny,   tw,   spacing,   border,   fontsize)
...
if IsNothing (pixas) then Throw New ArgumentNullException  ("pixas cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixaConvertToNUpPixa(pixas.Pointer, saPtr,   nx,   ny,   tw,   spacing,   border,   fontsize)
...
if IsNothing (pixa1) then Throw New ArgumentNullException  ("pixa1 cannot be Nothing")
		...
		if IsNothing (fileout) then Throw New ArgumentNullException  ("fileout cannot be Nothing")
	Dim _Result as Integer = Natives.pixaCompareInPdf(pixa1.Pointer, pixa2.Pointer,   nx,   ny,   tw,   spacing,   border,   fontsize,   fileout)
