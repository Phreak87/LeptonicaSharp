...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixProjectiveSampledPta(pixs.Pointer, ptad.Pointer, ptas.Pointer,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixProjectiveSampled(pixs.Pointer,   vc,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (ptad) then Throw New ArgumentNullException  ("ptad cannot be Nothing")
		if IsNothing (ptas) then Throw New ArgumentNullException  ("ptas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixProjectivePta(pixs.Pointer, ptad.Pointer, ptas.Pointer,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixProjective(pixs.Pointer,   vc,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (ptad) then Throw New ArgumentNullException  ("ptad cannot be Nothing")
		if IsNothing (ptas) then Throw New ArgumentNullException  ("ptas cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixProjectivePtaColor(pixs.Pointer, ptad.Pointer, ptas.Pointer,   colorval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixProjectiveColor(pixs.Pointer,   vc,   colorval)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as IntPtr = Natives.pixProjectivePtaGray(pixs.Pointer, ptad.Pointer, ptas.Pointer,   grayval)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as IntPtr = Natives.pixProjectiveGray(pixs.Pointer,   vc,   grayval)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	...
	Dim _Result as IntPtr = Natives.pixProjectivePtaWithAlpha(pixs.Pointer, ptad.Pointer, ptas.Pointer, pixgPtr,   fract,   border)
...
if IsNothing (ptas) then Throw New ArgumentNullException  ("ptas cannot be Nothing")
	...
	Dim _Result as Integer = Natives.getProjectiveXformCoeffs(ptas.Pointer, ptad.Pointer,   pvcPtr)
...
if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as Integer = Natives.projectiveXformSampledPt(  vc,   x,   y,   pxp,   pyp)
...
if IsNothing (vc) then Throw New ArgumentNullException  ("vc cannot be Nothing")
	Dim _Result as Integer = Natives.projectiveXformPt(  vc,   x,   y,   pxp,   pyp)
