...
Public Shared Function ptraCreate(
	...
	Dim _Result as IntPtr = Natives.ptraCreate(  n)
...
Public Shared Sub ptraDestroy(
	...
	Natives.ptraDestroy( ppaPtr,   freeflag,   warnflag)
	
	if ppaPtr = IntPtr.Zero then ppa = Nothing else ppa = new L_Ptra(ppaPtr)
End Sub
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.ptraAdd(pa.Pointer,   itemPtr)
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.ptraInsert(pa.Pointer,   index,   itemPtr,   shiftflag)
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	Dim _Result as IntPtr = Natives.ptraRemove(pa.Pointer,   index,   flag)
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	Dim _Result as IntPtr = Natives.ptraRemoveLast(pa.Pointer)
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.ptraReplace(pa.Pointer,   index,   itemPtr,   freeflag)
...
' ptra.c (553, 1)
' ptraSwap(pa, index1, index2) as Integer
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	Dim _Result as Integer = Natives.ptraSwap(pa.Pointer,   index1,   index2)
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	Dim _Result as Integer = Natives.ptraCompactArray(pa.Pointer)
	
	return _Result
End Function

' ptra.c (625, 1)
' ptraReverse(pa) as Integer
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	Dim _Result as Integer = Natives.ptraReverse(pa.Pointer)
	
	return _Result
End Function

' ptra.c (649, 1)
' ptraJoin(pa1, pa2) as Integer
...
if IsNothing (pa1) then Throw New ArgumentNullException  ("pa1 cannot be Nothing")
	...
	Dim _Result as Integer = Natives.ptraJoin(pa1.Pointer, pa2.Pointer)
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	Dim _Result as Integer = Natives.ptraGetMaxIndex(pa.Pointer,   pmaxindex)
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	Dim _Result as Integer = Natives.ptraGetActualCount(pa.Pointer,   pcount)
...
if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	Dim _Result as IntPtr = Natives.ptraGetPtrToItem(pa.Pointer,   index)
...
Public Shared Function ptraaCreate(
	...
	Dim _Result as IntPtr = Natives.ptraaCreate(  n)
...
Public Shared Sub ptraaDestroy(
	...
	Natives.ptraaDestroy( ppaaPtr,   freeflag,   warnflag)
	
	if ppaaPtr = IntPtr.Zero then ppaa = Nothing else ppaa = new L_Ptraa(ppaaPtr)
End Sub

' ptra.c (867, 1)
' ptraaGetSize(paa, psize) as Integer
...
if IsNothing (paa) then Throw New ArgumentNullException  ("paa cannot be Nothing")
	Dim _Result as Integer = Natives.ptraaGetSize(paa.Pointer,   psize)
...
if IsNothing (paa) then Throw New ArgumentNullException  ("paa cannot be Nothing")
		if IsNothing (pa) then Throw New ArgumentNullException  ("pa cannot be Nothing")
	Dim _Result as Integer = Natives.ptraaInsertPtra(paa.Pointer,   index, pa.Pointer)
...
if IsNothing (paa) then Throw New ArgumentNullException  ("paa cannot be Nothing")
	Dim _Result as IntPtr = Natives.ptraaGetPtra(paa.Pointer,   index,   accessflag)
...
if IsNothing (paa) then Throw New ArgumentNullException  ("paa cannot be Nothing")
	Dim _Result as IntPtr = Natives.ptraaFlattenToPtra(paa.Pointer)
