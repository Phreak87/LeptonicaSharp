...
if IsNothing (recs) then Throw New ArgumentNullException  ("recs cannot be Nothing")
	Dim _Result as IntPtr = Natives.recogCreateFromRecog(recs.Pointer,   scalew,   scaleh,   linew,   threshold,   maxyshift)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.recogCreateFromPixa(pixa.Pointer,   scalew,   scaleh,   linew,   threshold,   maxyshift)
...
if IsNothing (pixa) then Throw New ArgumentNullException  ("pixa cannot be Nothing")
	Dim _Result as IntPtr = Natives.recogCreateFromPixaNoFinish(pixa.Pointer,   scalew,   scaleh,   linew,   threshold,   maxyshift)
...
Public Shared Function recogCreate(
	...
	Dim _Result as IntPtr = Natives.recogCreate(  scalew,   scaleh,   linew,   threshold,   maxyshift)
...
Public Shared Sub recogDestroy(
	...
	Natives.recogDestroy( precogPtr)
...
if IsNothing (recog) then Throw New ArgumentNullException  ("recog cannot be Nothing")
	Dim _Result as Integer = Natives.recogGetCount(recog.Pointer)
...
if IsNothing (recog) then Throw New ArgumentNullException  ("recog cannot be Nothing")
	Dim _Result as Integer = Natives.recogSetParams(recog.Pointer,   type,   min_nopad,   max_wh_ratio,   max_ht_ratio)
...
if IsNothing (recog) then Throw New ArgumentNullException  ("recog cannot be Nothing")
	...
	Dim _Result as Integer = Natives.recogGetClassIndex(recog.Pointer,   val,   text,   pindex)
...
if IsNothing (recog) then Throw New ArgumentNullException  ("recog cannot be Nothing")
		if IsNothing (text) then Throw New ArgumentNullException  ("text cannot be Nothing")
	Dim _Result as Integer = Natives.recogStringToIndex(recog.Pointer,   text,   pindex)
...
if IsNothing (recog) then Throw New ArgumentNullException  ("recog cannot be Nothing")
	...
	Dim _Result as Integer = Natives.recogGetClassString(recog.Pointer,   index,   pcharstrPtr)
...
if IsNothing (str) then Throw New ArgumentNullException  ("str cannot be Nothing")
	Dim _Result as Integer = Natives.l_convertCharstrToInt(  str,   pval)
...
If My.Computer.Filesystem.FileExists (filename) = false then 
	...
	End If
	Dim _Result as IntPtr = Natives.recogRead(  filename)
...
if IsNothing (fp) then Throw New ArgumentNullException  ("fp cannot be Nothing")
	Dim _Result as IntPtr = Natives.recogReadStream(fp.Pointer)
...
if IsNothing (data) then Throw New ArgumentNullException  ("data cannot be Nothing")
	Dim _Result as IntPtr = Natives.recogReadMem(  data,   size)
...
if IsNothing (filename) then Throw New ArgumentNullException  ("filename cannot be Nothing")
		if IsNothing (recog) then Throw New ArgumentNullException  ("recog cannot be Nothing")
	Dim _Result as Integer = Natives.recogWrite(  filename, recog.Pointer)
...
if IsNothing (fp) then Throw New ArgumentNullException  ("fp cannot be Nothing")
		if IsNothing (recog) then Throw New ArgumentNullException  ("recog cannot be Nothing")
	Dim _Result as Integer = Natives.recogWriteStream(fp.Pointer, recog.Pointer)
...
if IsNothing (recog) then Throw New ArgumentNullException  ("recog cannot be Nothing")
	...
	Dim _Result as Integer = Natives.recogWriteMem(  pdataPtr,   psize, recog.Pointer)
...
if IsNothing (recog) then Throw New ArgumentNullException  ("recog cannot be Nothing")
	Dim _Result as IntPtr = Natives.recogExtractPixa(recog.Pointer)
