...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixRotate(pixs.Pointer,   angle,   type,   incolor,   width,   height)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixEmbedForRotation(pixs.Pointer,   angle,   incolor,   width,   height)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixRotateBySampling(pixs.Pointer,   xcen,   ycen,   angle,   incolor)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixRotateBinaryNice(pixs.Pointer,   angle,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixRotateWithAlpha(pixs.Pointer,   angle, pixgPtr,   fract)
