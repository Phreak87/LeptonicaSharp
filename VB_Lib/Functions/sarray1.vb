...
Public Shared Function sarrayCreate(
	...
	Dim _Result as IntPtr = Natives.sarrayCreate(  n)
...
if IsNothing (initstr) then Throw New ArgumentNullException  ("initstr cannot be Nothing")
	Dim _Result as IntPtr = Natives.sarrayCreateInitialized(  n,   initstr)
...
if IsNothing (_string_) then Throw New ArgumentNullException  ("_string_ cannot be Nothing")
	Dim _Result as IntPtr = Natives.sarrayCreateWordsFromString(  _string_)
...
if IsNothing (_string_) then Throw New ArgumentNullException  ("_string_ cannot be Nothing")
	Dim _Result as IntPtr = Natives.sarrayCreateLinesFromString(  _string_,   blankflag)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as IntPtr = Natives.sarrayCopy(sa.Pointer)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as IntPtr = Natives.sarrayClone(sa.Pointer)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
		if IsNothing (_string_) then Throw New ArgumentNullException  ("_string_ cannot be Nothing")
	Dim _Result as Integer = Natives.sarrayAddString(sa.Pointer,   _string_,   copyflag)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as String = Natives.sarrayRemoveString(sa.Pointer,   index)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.sarrayReplaceString(sa.Pointer,   index,   newstr,   copyflag)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as Integer = Natives.sarrayClear(sa.Pointer)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as Integer = Natives.sarrayGetCount(sa.Pointer)
...
Public Shared Function sarrayGetArray(
				ByVal sa as Sarray, 
				<Out()> Optional  ByRef pnalloc as Integer = 0, 
				<Out()> Optional  ByRef pn as Integer = 0) as String()


if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as IntPtr = Natives.sarrayGetArray(sa.Pointer,   pnalloc,   pn)
	
	Dim PTRArr(pn -1) As IntPtr
	Marshal.Copy(_Result, PTRArr, 0, PTRArr.Length)
	Dim BLST As New List(Of String)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as String = Natives.sarrayGetString(sa.Pointer,   index,   copyflag)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as Integer = Natives.sarrayGetRefcount(sa.Pointer)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as Integer = Natives.sarrayChangeRefcount(sa.Pointer,   delta)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as String = Natives.sarrayToString(sa.Pointer,   addnlflag)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as String = Natives.sarrayToStringRange(sa.Pointer,   first,   nstrings,   addnlflag)
...
if IsNothing (sa1) then Throw New ArgumentNullException  ("sa1 cannot be Nothing")
	...
	Dim _Result as Integer = Natives.sarrayJoin(sa1.Pointer, sa2.Pointer)
...
if IsNothing (sa1) then Throw New ArgumentNullException  ("sa1 cannot be Nothing")
		if IsNothing (sa2) then Throw New ArgumentNullException  ("sa2 cannot be Nothing")
	Dim _Result as Integer = Natives.sarrayAppendRange(sa1.Pointer, sa2.Pointer,   start,   _end_)
...
if IsNothing (sa1) then Throw New ArgumentNullException  ("sa1 cannot be Nothing")
	...
	Dim _Result as Integer = Natives.sarrayPadToSameSize(sa1.Pointer, sa2.Pointer,   padstring)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as IntPtr = Natives.sarrayConvertWordsToLines(sa.Pointer,   linesize)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.sarraySplitString(sa.Pointer,   str,   separators)
...
Public Shared Function sarraySelectBySubstring(
				...
				Optional ByVal substr as String = "") as Sarray


if IsNothing (sain) then Throw New ArgumentNullException  ("sain cannot be Nothing")
	Dim _Result as IntPtr = Natives.sarraySelectBySubstring(sain.Pointer,   substr)
...
if IsNothing (sain) then Throw New ArgumentNullException  ("sain cannot be Nothing")
	Dim _Result as IntPtr = Natives.sarraySelectByRange(sain.Pointer,   first,   last)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.sarrayParseRange(sa.Pointer,   start,   pactualstart,   pend,   pnewstart,   substr,   loc)
...
If My.Computer.Filesystem.FileExists (filename) = false then 
	...
	End If
	Dim _Result as IntPtr = Natives.sarrayRead(  filename)
...
if IsNothing (fp) then Throw New ArgumentNullException  ("fp cannot be Nothing")
	Dim _Result as IntPtr = Natives.sarrayReadStream(fp.Pointer)
...
if IsNothing (data) then Throw New ArgumentNullException  ("data cannot be Nothing")
	Dim _Result as IntPtr = Natives.sarrayReadMem(  data,   size)
...
if IsNothing (filename) then Throw New ArgumentNullException  ("filename cannot be Nothing")
		if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as Integer = Natives.sarrayWrite(  filename, sa.Pointer)
...
if IsNothing (fp) then Throw New ArgumentNullException  ("fp cannot be Nothing")
		if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as Integer = Natives.sarrayWriteStream(fp.Pointer, sa.Pointer)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	...
	Dim _Result as Integer = Natives.sarrayWriteMem(  pdataPtr,   psize, sa.Pointer)
...
If My.Computer.Filesystem.FileExists (filename) = false then 
	   Throw New ArgumentException ("File is missing")
	End If
	Dim _Result as Integer = Natives.sarrayAppend(  filename, sa.Pointer)
...
if IsNothing (dirname) then Throw New ArgumentNullException  ("dirname cannot be Nothing")
	Dim _Result as IntPtr = Natives.getNumberedPathnamesInDirectory(  dirname,   substr,   numpre,   numpost,   maxnum)
...
if IsNothing (dirname) then Throw New ArgumentNullException  ("dirname cannot be Nothing")
	Dim _Result as IntPtr = Natives.getSortedPathnamesInDirectory(  dirname,   substr,   first,   nfiles)
...
if IsNothing (sa) then Throw New ArgumentNullException  ("sa cannot be Nothing")
	Dim _Result as IntPtr = Natives.convertSortedToNumberedPathnames(sa.Pointer,   numpre,   numpost,   maxnum)
...
if IsNothing (dirname) then Throw New ArgumentNullException  ("dirname cannot be Nothing")
	Dim _Result as IntPtr = Natives.getFilenamesInDirectory(  dirname)
