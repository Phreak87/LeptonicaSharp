...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScale(pixs.Pointer,   scalex,   scaley)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleToSizeRel(pixs.Pointer,   delw,   delh)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleToSize(pixs.Pointer,   wd,   hd)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleGeneral(pixs.Pointer,   scalex,   scaley,   sharpfract,   sharpwidth)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleLI(pixs.Pointer,   scalex,   scaley)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleColorLI(pixs.Pointer,   scalex,   scaley)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleColor2xLI(pixs.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleColor4xLI(pixs.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleGrayLI(pixs.Pointer,   scalex,   scaley)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleGray2xLI(pixs.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleGray4xLI(pixs.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleGray2xLIThresh(pixs.Pointer,   thresh)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleGray2xLIDither(pixs.Pointer)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	Dim _Result as IntPtr = Natives.pixScaleGray4xLIThresh(pixs.Pointer,   thresh)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleGray4xLIDither(pixs.Pointer)
...
If {1,2,4,8,16,32}.contains (pixs.d) = false then Throw New ArgumentException ("1, 2, 4, 8, 16, 32 bpp")
	Dim _Result as IntPtr = Natives.pixScaleBySampling(pixs.Pointer,   scalex,   scaley)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleBySamplingToSize(pixs.Pointer,   wd,   hd)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1,2,4,8,16,32}.contains (pixs.d) = false then Throw New ArgumentException ("1, 2, 4, 8, 16, 32 bpp")
	Dim _Result as IntPtr = Natives.pixScaleByIntSampling(pixs.Pointer,   factor)
...
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixScaleRGBToGrayFast(pixs.Pointer,   factor,   color)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp RGB")
	Dim _Result as IntPtr = Natives.pixScaleRGBToBinaryFast(pixs.Pointer,   factor,   thresh)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp grayscale")
	Dim _Result as IntPtr = Natives.pixScaleGrayToBinaryFast(pixs.Pointer,   factor,   thresh)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleSmooth(pix.Pointer,   scalex,   scaley)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleSmoothToSize(pixs.Pointer,   wd,   hd)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {32}.contains (pixs.d) = false then Throw New ArgumentException ("32 bpp rgb")
	Dim _Result as IntPtr = Natives.pixScaleRGBToGray2(pixs.Pointer,   rwt,   gwt,   bwt)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleAreaMap(pix.Pointer,   scalex,   scaley)
...
if IsNothing (pix) then Throw New ArgumentNullException  ("pix cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleAreaMap2(pix.Pointer)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixScaleAreaMapToSize(pixs.Pointer,   wd,   hd)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixScaleBinary(pixs.Pointer,   scalex,   scaley)
