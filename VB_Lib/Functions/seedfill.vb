...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixSeedfillBinary(pixdPtr, pixs.Pointer, pixm.Pointer,   connectivity)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixSeedfillBinaryRestricted(pixdPtr, pixs.Pointer, pixm.Pointer,   connectivity,   xmax,   ymax)
...
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixHolesByFilling(pixs.Pointer,   connectivity)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixFillClosedBorders(pixs.Pointer,   connectivity)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixExtractBorderConnComps(pixs.Pointer,   connectivity)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixRemoveBorderConnComps(pixs.Pointer,   connectivity)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixFillBgFromBorder(pixs.Pointer,   connectivity)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
If {1}.contains (pixs.d) = false then Throw New ArgumentException ("1 bpp")
	Dim _Result as IntPtr = Natives.pixFillHolesToBoundingRect(pixs.Pointer,   minsize,   maxhfract,   minfgfract)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (pixm) then Throw New ArgumentNullException  ("pixm cannot be Nothing")
	Dim _Result as Integer = Natives.pixSeedfillGray(pixs.Pointer, pixm.Pointer,   connectivity)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (pixm) then Throw New ArgumentNullException  ("pixm cannot be Nothing")
	Dim _Result as Integer = Natives.pixSeedfillGrayInv(pixs.Pointer, pixm.Pointer,   connectivity)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (pixm) then Throw New ArgumentNullException  ("pixm cannot be Nothing")
	Dim _Result as Integer = Natives.pixSeedfillGraySimple(pixs.Pointer, pixm.Pointer,   connectivity)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
		if IsNothing (pixm) then Throw New ArgumentNullException  ("pixm cannot be Nothing")
	Dim _Result as Integer = Natives.pixSeedfillGrayInvSimple(pixs.Pointer, pixm.Pointer,   connectivity)
...
if IsNothing (pixb) then Throw New ArgumentNullException  ("pixb cannot be Nothing")
		if IsNothing (pixm) then Throw New ArgumentNullException  ("pixm cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixSeedfillGrayBasin(pixb.Pointer, pixm.Pointer,   delta,   connectivity)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixDistanceFunction(pixs.Pointer,   connectivity,   outdepth,   boundcond)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixSeedspread(pixs.Pointer,   connectivity)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	...
	Dim _Result as Integer = Natives.pixLocalExtrema(pixs.Pointer,   maxmin,   minmax, ppixminPtr, ppixmaxPtr)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	...
	Dim _Result as Integer = Natives.pixSelectedLocalExtrema(pixs.Pointer,   mindist, ppixminPtr, ppixmaxPtr)
...
If {8}.contains (pixs1.d) = false then Throw New ArgumentException ("8 bpp")
	...
	Dim _Result as IntPtr = Natives.pixFindEqualValues(pixs1.Pointer, pixs2.Pointer)
...
If {8}.contains (pixs.d) = false then Throw New ArgumentException ("8 bpp")
	...
	Dim _Result as Integer = Natives.pixSelectMinInConnComp(pixs.Pointer, pixm.Pointer, pptaPtr, pnavPtr)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixRemoveSeededComponents(pixdPtr, pixs.Pointer, pixm.Pointer,   connectivity,   bordersize)
