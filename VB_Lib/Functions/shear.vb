...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixHShear(pixdPtr, pixs.Pointer,   yloc,   radang,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixVShear(pixdPtr, pixs.Pointer,   xloc,   radang,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixHShearCorner(pixdPtr, pixs.Pointer,   radang,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixVShearCorner(pixdPtr, pixs.Pointer,   radang,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixHShearCenter(pixdPtr, pixs.Pointer,   radang,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	...
	Dim _Result as IntPtr = Natives.pixVShearCenter(pixdPtr, pixs.Pointer,   radang,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixHShearIP(pixs.Pointer,   yloc,   radang,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as Integer = Natives.pixVShearIP(pixs.Pointer,   xloc,   radang,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixHShearLI(pixs.Pointer,   yloc,   radang,   incolor)
...
if IsNothing (pixs) then Throw New ArgumentNullException  ("pixs cannot be Nothing")
	Dim _Result as IntPtr = Natives.pixVShearLI(pixs.Pointer,   xloc,   radang,   incolor)
